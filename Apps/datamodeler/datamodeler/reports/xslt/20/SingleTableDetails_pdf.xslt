...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:altova="http://www.altova.com" xmlns:altovaext="http://www.altova.com/xslt-extensions" xmlns:clitype="clitype" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:iso4217="http://www.xbrl.org/2003/iso4217" xmlns:ix="http://www.xbrl.org/2008/inlineXBRL" xmlns:java="java" xmlns:link="http://www.xbrl.org/2003/linkbase" xmlns:n1="osdm_t" xmlns:sps="http://www.altova.com/StyleVision/user-xpath-functions" xmlns:xbrldi="http://xbrl.org/2006/xbrldi" xmlns:xbrli="http://www.xbrl.org/2003/instance" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:fo="http://www.w3.org/1999/XSL/Format" xmlns:svg="http://www.w3.org/2000/svg" exclude-result-prefixes="#all">
	...
	<xsl:variable name="fo:layout-master-set">
		<fo:layout-master-set>
			<fo:simple-page-master master-name="page-master-176331256-even" margin-left="2cm" margin-right="2cm" page-height="21cm" page-width="29.70cm" margin-top="0.7cm" margin-bottom="0.7cm">
			...
			<fo:simple-page-master master-name="page-master-176331256-odd" margin-left="2cm" margin-right="2cm" page-height="21cm" page-width="29.70cm" margin-top="0.7cm" margin-bottom="0.7cm">
				<fo:region-body margin-top="1.30cm" margin-bottom="1.30cm" column-count="1"/>
				<fo:region-after region-name="odd-page-footer" overflow="hidden" extent="1.30cm"/>
			</fo:simple-page-master>
			<fo:simple-page-master master-name="page-master-176331256-even-first" margin-left="2cm" margin-right="2cm" page-height="21cm" page-width="29.70cm" margin-top="0.7cm" margin-bottom="0.7cm">
				<fo:region-body margin-top="1.30cm" margin-bottom="1.30cm" column-count="1"/>
				<fo:region-after region-name="even-page-footer" overflow="hidden" extent="1.30cm"/>
			</fo:simple-page-master>
			<fo:simple-page-master master-name="page-master-176331256-odd-first" margin-left="2cm" margin-right="2cm" page-height="21cm" page-width="29.70cm" margin-top="0.7cm" margin-bottom="0.7cm">
				<fo:region-body margin-top="1.30cm" margin-bottom="1.30cm" column-count="1"/>
				<fo:region-after region-name="odd-page-footer" overflow="hidden" extent="1.30cm"/>
			</fo:simple-page-master>
			<fo:simple-page-master master-name="page-master-176331256-even-last" margin-left="2cm" margin-right="2cm" page-height="21cm" page-width="29.70cm" margin-top="0.7cm" margin-bottom="0.7cm">
				<fo:region-body margin-top="1.30cm" margin-bottom="1.30cm" column-count="1"/>
				<fo:region-after region-name="even-page-footer" overflow="hidden" extent="1.30cm"/>
			</fo:simple-page-master>
			<fo:simple-page-master master-name="page-master-176331256-odd-last" margin-left="2cm" margin-right="2cm" page-height="21cm" page-width="29.70cm" margin-top="0.7cm" margin-bottom="0.7cm">
				<fo:region-body margin-top="1.30cm" margin-bottom="1.30cm" column-count="1"/>
				<fo:region-after region-name="odd-page-footer" overflow="hidden" extent="1.30cm"/>
			</fo:simple-page-master>
			<fo:page-sequence-master master-name="page-master-176331256">
				<fo:repeatable-page-master-alternatives>
					<fo:conditional-page-master-reference master-reference="page-master-176331256-even-first" odd-or-even="even" page-position="first"/>
					<fo:conditional-page-master-reference master-reference="page-master-176331256-odd-first" odd-or-even="odd" page-position="first"/>
					<fo:conditional-page-master-reference master-reference="page-master-176331256-even-last" odd-or-even="even" page-position="last"/>
					<fo:conditional-page-master-reference master-reference="page-master-176331256-odd-last" odd-or-even="odd" page-position="last"/>
					<fo:conditional-page-master-reference master-reference="page-master-176331256-even" odd-or-even="even"/>
					<fo:conditional-page-master-reference master-reference="page-master-176331256-odd" odd-or-even="odd"/>
				</fo:repeatable-page-master-alternatives>
	...
	<xsl:variable name="altova:design-xslt-tree-view">
		<altova:main-document url="{if ($SV_BaseOutputFileName) then concat($SV_BaseOutputFileName,'.fo') else ''}">
			<fo:root>
				...
				<fo:page-sequence master-reference="page-master-176331256" initial-page-number="auto" format="1" force-page-count="no-force">
							...
							<fo:block font-family="Tahoma" font-size="xx-small">
								<xsl:variable name="altova:table">
									<fo:table font-size="xx-small" width="25cm" table-layout="fixed" border-spacing="0">
										...
										<xsl:variable name="altova:CurrContextGrid_081520F8" select="."/>
								...
								<xsl:for-each select="n1:root">
									...
									<xsl:variable name="altova:table">
										<fo:table width="20cm" table-layout="fixed" border-spacing="0">
											...
											<xsl:variable name="altova:CurrContextGrid_0834D080" select="."/>
											<xsl:variable name="altova:ColumnData">
												<altova:Internal/>
											</xsl:variable>
											<fo:table-body start-indent="0pt">
									...
									<xsl:variable name="altova:table">
										<fo:table width="15cm" table-layout="fixed" border-spacing="0">
											...
											<xsl:variable name="altova:CurrContextGrid_0832AF90" select="."/>
											<xsl:variable name="altova:ColumnData">
												<altova:Internal/>
											</xsl:variable>
											<fo:table-body start-indent="0pt">
										...
										<xsl:for-each select="n1:DescriptionNotes">
											<xsl:variable name="altova:table">
												<fo:table width="20cm" table-layout="fixed" border-spacing="0">
													<fo:table-column column-width="4cm"/>
													<fo:table-column column-width="16cm"/>
													<xsl:variable name="altova:CurrContextGrid_08140AA8" select="."/>
													<xsl:variable name="altova:ColumnData">
														<altova:Internal/>
													</xsl:variable>
													<fo:table-body start-indent="0pt">
										...
										<xsl:for-each select="n1:QuantitativeInfoCollection">
											<xsl:variable name="altova:table">
												<fo:table width="8cm" table-layout="fixed" border-spacing="0">
													<fo:table-column column-width="4cm"/>
													<fo:table-column column-width="4cm"/>
													<xsl:variable name="altova:CurrContextGrid_0809B9D0" select="."/>
													<xsl:variable name="altova:ColumnData">
														<altova:Internal/>
													</xsl:variable>
													<fo:table-body start-indent="0pt">
									...
									<xsl:if test="count( n1:DiagramsCollection)">
										...
										<xsl:variable name="altova:table">
											<fo:table width="8cm" table-layout="fixed" border-spacing="0">
												...
												<xsl:variable name="altova:CurrContextGrid_08372AE8" select="."/>
												<xsl:variable name="altova:ColumnData">
													<altova:Internal/>
												</xsl:variable>
												<fo:table-body start-indent="0pt">
									...
									<xsl:if test="count( n1:ColumnsCollection )">
										...
										<xsl:variable name="altova:table">
											<fo:table width="25cm" table-layout="fixed" border-spacing="0">
												...
												<fo:table-column column-width="2.900cm"/>
												<fo:table-column column-width="2.900cm"/>
												<xsl:variable name="altova:CurrContextGrid_09C41E50" select="."/>
												<xsl:variable name="altova:ColumnData">
													<altova:Internal/>
												</xsl:variable>
									...
									<xsl:if test="count( n1:ColumnsCommentsCollection )">
										...
										<xsl:variable name="altova:table">
											<fo:table width="25cm" table-layout="fixed" border-spacing="0">
												...
												<fo:table-column column-width="9cm"/>
												<xsl:variable name="altova:CurrContextGrid_0833A510" select="."/>
												<xsl:variable name="altova:ColumnData">
													<altova:Internal/>
												</xsl:variable>
									...
									<xsl:if test="count( n1:IndexesCollection )">
										...
										<xsl:variable name="altova:table">
											<fo:table width="25cm" table-layout="fixed" border-spacing="0">
												...
												<fo:table-column column-width="6cm"/>
												<fo:table-column column-width="1.500cm"/>
												<xsl:variable name="altova:CurrContextGrid_084E0378" select="."/>
												<xsl:variable name="altova:ColumnData">
													<altova:Internal/>
												</xsl:variable>
												<fo:table-header background-color="#d9f5ff" start-indent="0pt">
									...
									<xsl:if test="count( n1:ConstraintsCollection )">
										...
										<xsl:variable name="altova:table">
											<fo:table width="25cm" table-layout="fixed" border-spacing="0" altova:hide-rows="body-empty" altova:hide-cols="body-empty">
												...
												<xsl:variable name="altova:CurrContextGrid_09B81AB8" select="."/>
												<xsl:variable name="altova:ColumnData">
													<altova:Internal/>
												</xsl:variable>
												<fo:table-header background-color="#d9f5ff" start-indent="0pt">
																			...
																			<xsl:if test="count( n1:RangesCollection ) != 0">
																				<xsl:variable name="altova:table">
																					<fo:table width="18.5cm" table-layout="fixed" border-spacing="0">
																						...
																						<xsl:variable name="altova:CurrContextGrid_084CB958" select="."/>
																						<xsl:variable name="altova:ColumnData">
																							<altova:Internal/>
																						</xsl:variable>
																						<fo:table-header background-color="#d9f5ff" start-indent="0pt">
																			...
																			<xsl:if test="count( n1:ValueListsCollection ) != 0">
																				...
																				<xsl:variable name="altova:table">
																					<fo:table width="18.5cm" table-layout="fixed" border-spacing="0">
																						...
																						<xsl:variable name="altova:CurrContextGrid_09BC9FB8" select="."/>
																						<xsl:variable name="altova:ColumnData">
																							<altova:Internal/>
																						</xsl:variable>
																						<fo:table-header background-color="#d9f5ff" start-indent="0pt">
																			...
																			<xsl:if test="count( n1:CheckConstraintsCollection ) != 0">
																				...
																				<xsl:variable name="altova:table">
																					<fo:table width="18.5cm" table-layout="fixed" border-spacing="0">
																						<fo:table-column column-width="15.500cm"/>
																						<fo:table-column column-width="3cm"/>
																						<xsl:variable name="altova:CurrContextGrid_08486A80" select="."/>
																						<xsl:variable name="altova:ColumnData">
																							<altova:Internal/>
																						</xsl:variable>
																						<fo:table-header background-color="#d9f5ff" start-indent="0pt">
									...
									<xsl:if test="count( n1:FKRTCollection )">
										...
										<xsl:variable name="altova:table">
											<fo:table width="25cm" table-layout="fixed" border-spacing="0">
												...
												<fo:table-column column-width="2cm"/>
												<fo:table-column column-width="6cm"/>
												<xsl:variable name="altova:CurrContextGrid_0AC8A7C0" select="."/>
												<xsl:variable name="altova:ColumnData">
													<altova:Internal/>
												</xsl:variable>
												<fo:table-header background-color="#d9f5ff" start-indent="0pt">
									...
									<xsl:if test="count( n1:FKRFCollection )">
										...
										<xsl:variable name="altova:table">
											<fo:table width="25cm" table-layout="fixed" border-spacing="0">
												...
												<fo:table-column column-width="2cm"/>
												<fo:table-column column-width="6cm"/>
												<xsl:variable name="altova:CurrContextGrid_09FCBAF8" select="."/>
												<xsl:variable name="altova:ColumnData">
													<altova:Internal/>
												</xsl:variable>
												<fo:table-header background-color="#d9f5ff" start-indent="0pt">

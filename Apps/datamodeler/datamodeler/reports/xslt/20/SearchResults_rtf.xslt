...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:altova="http://www.altova.com" xmlns:altovaext="http://www.altova.com/xslt-extensions" xmlns:clitype="clitype" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:iso4217="http://www.xbrl.org/2003/iso4217" xmlns:ix="http://www.xbrl.org/2008/inlineXBRL" xmlns:java="java" xmlns:link="http://www.xbrl.org/2003/linkbase" xmlns:n1="osdm_srs" xmlns:sps="http://www.altova.com/StyleVision/user-xpath-functions" xmlns:xbrldi="http://xbrl.org/2006/xbrldi" xmlns:xbrli="http://www.xbrl.org/2003/instance" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" exclude-result-prefixes="#all">
	...
	<xsl:variable name="altova:DocumentMonolith">
		<altova:Document altova:Url="{if ($SV_BaseOutputFileName) then concat($SV_BaseOutputFileName,'.rtf') else ''}">
			...
			<xsl:text>}</xsl:text>
			<altova:DocumentSection altova:PageWidthPt="841" altova:MarginLeftPt="43" altova:MarginRightPt="43"/>
			...
			<xsl:for-each select="$XML">
				...
				<xsl:if test="n1:root/n1:ShowFilter = &apos;true&apos;">
					...
					<altova:table>
						...
						<altova:table-row>
							...
							<altova:table-cell altova:whitespace="preserve-all" altova:character-styles="\fs16\b" altova:character-reset-styles="\fs24\b0" altova:paragraph-styles="\sl0">
				...
				<xsl:for-each select="n1:root">
					...
					<xsl:variable name="altova:ColumnData">
						<altova:Internal/>
						<xsl:for-each select="*[n1:Column1/n1:show = &apos;Y&apos;]">
							<xsl:variable name="vvvvvvvvvv" select="$XML/n1:root/n1:ObjectsCollection/n1:Column1/n1:width"/>
							<altova:Element altova:sDesignElemId="4">
								<xsl:choose>
									<xsl:when test=". instance of node()">
										<xsl:attribute name="altova:sNodeId" select="generate-id(.)"/>
										<xsl:attribute name="altova:sDocumentUri" select="document-uri(root(.))"/>
									</xsl:when>
									<xsl:otherwise>
										<xsl:attribute name="altova:nPos" select="position()"/>
									</xsl:otherwise>
								</xsl:choose>
							</altova:Element>
						</xsl:for-each>
						<xsl:for-each select="*[n1:Column2/n1:show = &apos;Y&apos;]">
							<altova:Element altova:sDesignElemId="5">
								<xsl:choose>
									<xsl:when test=". instance of node()">
										<xsl:attribute name="altova:sNodeId" select="generate-id(.)"/>
										<xsl:attribute name="altova:sDocumentUri" select="document-uri(root(.))"/>
						...
						<xsl:for-each select="*[n1:Column3/n1:show = &apos;Y&apos;]">
							<altova:Element altova:sDesignElemId="6">
								<xsl:choose>
									<xsl:when test=". instance of node()">
										<xsl:attribute name="altova:sNodeId" select="generate-id(.)"/>
										<xsl:attribute name="altova:sDocumentUri" select="document-uri(root(.))"/>
						...
						<xsl:for-each select="*[n1:Column4/n1:show = &apos;Y&apos;]">
							<altova:Element altova:sDesignElemId="7">
								<xsl:choose>
									<xsl:when test=". instance of node()">
										<xsl:attribute name="altova:sNodeId" select="generate-id(.)"/>
										<xsl:attribute name="altova:sDocumentUri" select="document-uri(root(.))"/>
						...
						<xsl:for-each select="*[n1:Column5/n1:show = &apos;Y&apos;]">
							<altova:Element altova:sDesignElemId="8">
								<xsl:choose>
									<xsl:when test=". instance of node()">
										<xsl:attribute name="altova:sNodeId" select="generate-id(.)"/>
										<xsl:attribute name="altova:sDocumentUri" select="document-uri(root(.))"/>
						...
						<xsl:for-each select="*[n1:Column6/n1:show = &apos;Y&apos;]">
							<altova:Element altova:sDesignElemId="9">
								<xsl:choose>
									<xsl:when test=". instance of node()">
										<xsl:attribute name="altova:sNodeId" select="generate-id(.)"/>
										<xsl:attribute name="altova:sDocumentUri" select="document-uri(root(.))"/>
						...
						<xsl:for-each select="*[n1:Column7/n1:show = &apos;Y&apos;]">
							<altova:Element altova:sDesignElemId="10">
								<xsl:choose>
									<xsl:when test=". instance of node()">
										<xsl:attribute name="altova:sNodeId" select="generate-id(.)"/>
										<xsl:attribute name="altova:sDocumentUri" select="document-uri(root(.))"/>
						...
						<xsl:for-each select="*[n1:Column8/n1:show = &apos;Y&apos;]">
							<altova:Element altova:sDesignElemId="11">
								<xsl:choose>
									<xsl:when test=". instance of node()">
										<xsl:attribute name="altova:sNodeId" select="generate-id(.)"/>
										<xsl:attribute name="altova:sDocumentUri" select="document-uri(root(.))"/>
						...
						<xsl:for-each select="*[n1:Column9/n1:show = &apos;Y&apos;]">
							<altova:Element altova:sDesignElemId="12">
								<xsl:choose>
									<xsl:when test=". instance of node()">
										<xsl:attribute name="altova:sNodeId" select="generate-id(.)"/>
										<xsl:attribute name="altova:sDocumentUri" select="document-uri(root(.))"/>
						...
						<xsl:for-each select="*[n1:Column10/n1:show = &apos;Y&apos;]">
							<altova:Element altova:sDesignElemId="13">
								<xsl:choose>
									<xsl:when test=". instance of node()">
										<xsl:attribute name="altova:sNodeId" select="generate-id(.)"/>
										<xsl:attribute name="altova:sDocumentUri" select="document-uri(root(.))"/>
						...
						<xsl:for-each select="*[n1:Column11/n1:show = &apos;Y&apos;]">
							<altova:Element altova:sDesignElemId="14">
								<xsl:choose>
									<xsl:when test=". instance of node()">
										<xsl:attribute name="altova:sNodeId" select="generate-id(.)"/>
										<xsl:attribute name="altova:sDocumentUri" select="document-uri(root(.))"/>
						...
						<xsl:for-each select="*[n1:Column12/n1:show = &apos;Y&apos;]">
							<altova:Element altova:sDesignElemId="15">
								<xsl:choose>
									<xsl:when test=". instance of node()">
										<xsl:attribute name="altova:sNodeId" select="generate-id(.)"/>
										<xsl:attribute name="altova:sDocumentUri" select="document-uri(root(.))"/>
						...
						<xsl:for-each select="*[n1:Column13/n1:show = &apos;Y&apos;]">
							<altova:Element altova:sDesignElemId="16">
								<xsl:choose>
									<xsl:when test=". instance of node()">
										<xsl:attribute name="altova:sNodeId" select="generate-id(.)"/>
										<xsl:attribute name="altova:sDocumentUri" select="document-uri(root(.))"/>
						...
						<xsl:for-each select="*[n1:Column14/n1:show = &apos;Y&apos;]">
							<altova:Element altova:sDesignElemId="17">
								<xsl:choose>
									<xsl:when test=". instance of node()">
										<xsl:attribute name="altova:sNodeId" select="generate-id(.)"/>
										<xsl:attribute name="altova:sDocumentUri" select="document-uri(root(.))"/>
						...
						<xsl:for-each select="*[n1:Column15/n1:show = &apos;Y&apos;]">
							<altova:Element altova:sDesignElemId="18">
								<xsl:choose>
									<xsl:when test=". instance of node()">
										<xsl:attribute name="altova:sNodeId" select="generate-id(.)"/>
										<xsl:attribute name="altova:sDocumentUri" select="document-uri(root(.))"/>
						...
						<xsl:for-each select="*[n1:Column16/n1:show = &apos;Y&apos;]">
							<altova:Element altova:sDesignElemId="19">
								<xsl:choose>
									<xsl:when test=". instance of node()">
										<xsl:attribute name="altova:sNodeId" select="generate-id(.)"/>
										<xsl:attribute name="altova:sDocumentUri" select="document-uri(root(.))"/>
						...
						<xsl:for-each select="*[n1:Column17/n1:show = &apos;Y&apos;]">
							<altova:Element altova:sDesignElemId="20">
								<xsl:choose>
									<xsl:when test=". instance of node()">
										<xsl:attribute name="altova:sNodeId" select="generate-id(.)"/>
										<xsl:attribute name="altova:sDocumentUri" select="document-uri(root(.))"/>
						...
						<xsl:for-each select="*[n1:Column18/n1:show = &apos;Y&apos;]">
							<altova:Element altova:sDesignElemId="21">
								<xsl:choose>
									<xsl:when test=". instance of node()">
										<xsl:attribute name="altova:sNodeId" select="generate-id(.)"/>
										<xsl:attribute name="altova:sDocumentUri" select="document-uri(root(.))"/>
						...
						<xsl:for-each select="*[n1:Column19/n1:show = &apos;Y&apos;]">
							<altova:Element altova:sDesignElemId="22">
								<xsl:choose>
									<xsl:when test=". instance of node()">
										<xsl:attribute name="altova:sNodeId" select="generate-id(.)"/>
										<xsl:attribute name="altova:sDocumentUri" select="document-uri(root(.))"/>
						...
						<xsl:for-each select="*[n1:Column20/n1:show = &apos;Y&apos;]">
							<altova:Element altova:sDesignElemId="23">
								<xsl:choose>
									<xsl:when test=". instance of node()">
										<xsl:attribute name="altova:sNodeId" select="generate-id(.)"/>
										<xsl:attribute name="altova:sDocumentUri" select="document-uri(root(.))"/>
						...
						<xsl:for-each select="*[n1:Column21/n1:show = &apos;Y&apos;]">
							<altova:Element altova:sDesignElemId="24">
								<xsl:choose>
									<xsl:when test=". instance of node()">
										<xsl:attribute name="altova:sNodeId" select="generate-id(.)"/>
										<xsl:attribute name="altova:sDocumentUri" select="document-uri(root(.))"/>
						...
						<xsl:for-each select="*[n1:Column22/n1:show = &apos;Y&apos;]">
							<altova:Element altova:sDesignElemId="25">
								<xsl:choose>
									<xsl:when test=". instance of node()">
										<xsl:attribute name="altova:sNodeId" select="generate-id(.)"/>
										<xsl:attribute name="altova:sDocumentUri" select="document-uri(root(.))"/>
						...
						<xsl:for-each select="*[n1:Column23/n1:show = &apos;Y&apos;]">
							<altova:Element altova:sDesignElemId="26">
								<xsl:choose>
									<xsl:when test=". instance of node()">
										<xsl:attribute name="altova:sNodeId" select="generate-id(.)"/>
										<xsl:attribute name="altova:sDocumentUri" select="document-uri(root(.))"/>
						...
						<xsl:for-each select="*[n1:Column24/n1:show = &apos;Y&apos;]">
							<altova:Element altova:sDesignElemId="27">
								<xsl:choose>
									<xsl:when test=". instance of node()">
										<xsl:attribute name="altova:sNodeId" select="generate-id(.)"/>
										<xsl:attribute name="altova:sDocumentUri" select="document-uri(root(.))"/>
						...
						<xsl:for-each select="*[n1:Column25/n1:show = &apos;Y&apos;]">
							<altova:Element altova:sDesignElemId="28">
								<xsl:choose>
									<xsl:when test=". instance of node()">
										<xsl:attribute name="altova:sNodeId" select="generate-id(.)"/>
										<xsl:attribute name="altova:sDocumentUri" select="document-uri(root(.))"/>
						...
						<xsl:for-each select="*[n1:Column26/n1:show = &apos;Y&apos;]">
							<altova:Element altova:sDesignElemId="29">
								<xsl:choose>
									<xsl:when test=". instance of node()">
										<xsl:attribute name="altova:sNodeId" select="generate-id(.)"/>
										<xsl:attribute name="altova:sDocumentUri" select="document-uri(root(.))"/>
						...
						<xsl:for-each select="*[n1:Column27/n1:show = &apos;Y&apos;]">
							<altova:Element altova:sDesignElemId="30">
								<xsl:choose>
									<xsl:when test=". instance of node()">
										<xsl:attribute name="altova:sNodeId" select="generate-id(.)"/>
										<xsl:attribute name="altova:sDocumentUri" select="document-uri(root(.))"/>
						...
						<xsl:for-each select="*[n1:Column28/n1:show = &apos;Y&apos;]">
							<altova:Element altova:sDesignElemId="31">
								<xsl:choose>
									<xsl:when test=". instance of node()">
										<xsl:attribute name="altova:sNodeId" select="generate-id(.)"/>
										<xsl:attribute name="altova:sDocumentUri" select="document-uri(root(.))"/>
						...
						<xsl:for-each select="*[n1:Column29/n1:show = &apos;Y&apos;]">
							<altova:Element altova:sDesignElemId="32">
								<xsl:choose>
									<xsl:when test=". instance of node()">
										<xsl:attribute name="altova:sNodeId" select="generate-id(.)"/>
										<xsl:attribute name="altova:sDocumentUri" select="document-uri(root(.))"/>
						...
						<xsl:for-each select="*[n1:Column30/n1:show = &apos;Y&apos;]">
							<altova:Element altova:sDesignElemId="33">
								<xsl:choose>
									<xsl:when test=". instance of node()">
										<xsl:attribute name="altova:sNodeId" select="generate-id(.)"/>
										<xsl:attribute name="altova:sDocumentUri" select="document-uri(root(.))"/>
					...
					<altova:table>
						...
						<xsl:variable name="altova:nColumnsWithDefaultWidth_1" select="count($altova:ColumnData//altova:UsesDefaultWidth)"/>
						<xsl:variable name="altova:nColumnsWithDefaultWidthNotZero_1">
							<xsl:choose>
								<xsl:when test="$altova:nColumnsWithDefaultWidth_1 = 0">
									<xsl:value-of select="round(count((*[n1:Column1/n1:show = 'Y'])) + count((*[n1:Column2/n1:show = 'Y'])) + count((*[n1:Column3/n1:show = 'Y'])) + count((*[n1:Column4/n1:show = 'Y'])) + count((*[n1:Column5/n1:show = 'Y'])) + count((*[n1:Column6/n1:show = 'Y'])) + count((*[n1:Column7/n1:show = 'Y'])) + count((*[n1:Column8/n1:show = 'Y'])) + count((*[n1:Column9/n1:show = 'Y'])) + count((*[n1:Column10/n1:show = 'Y'])) + count((*[n1:Column11/n1:show = 'Y'])) + count((*[n1:Column12/n1:show = 'Y'])) + count((*[n1:Column13/n1:show = 'Y'])) + count((*[n1:Column14/n1:show = 'Y'])) + count((*[n1:Column15/n1:show = 'Y'])) + count((*[n1:Column16/n1:show = 'Y'])) + count((*[n1:Column17/n1:show = 'Y'])) + count((*[n1:Column18/n1:show = 'Y'])) + count((*[n1:Column19/n1:show = 'Y'])) + count((*[n1:Column20/n1:show = 'Y'])) + count((*[n1:Column21/n1:show = 'Y'])) + count((*[n1:Column22/n1:show = 'Y'])) + count((*[n1:Column23/n1:show = 'Y'])) + count((*[n1:Column24/n1:show = 'Y'])) + count((*[n1:Column25/n1:show = 'Y'])) + count((*[n1:Column26/n1:show = 'Y'])) + count((*[n1:Column27/n1:show = 'Y'])) + count((*[n1:Column28/n1:show = 'Y'])) + count((*[n1:Column29/n1:show = 'Y'])) + count((*[n1:Column30/n1:show = 'Y'])))"/>
								</xsl:when>
								<xsl:otherwise>
						...
						<altova:table-row>
							<xsl:variable name="altova:RowStyle">
								...
								<xsl:for-each select="$altova:CurrContextGrid_3">
									<xsl:variable name="altova:nodesNextPseudo" select="$altova:ColumnData/altova:Element[ @altova:sDesignElemId = 4 ]"/>
									<xsl:for-each select="$altova:CurrContextGrid_3">
										<xsl:for-each select="for $altova:nodePseudo in $altova:nodesNextPseudo return if( exists( $altova:nodePseudo/@altova:sNodeId ) ) then key('altova:id-key',$altova:nodePseudo/@altova:sNodeId,document($altova:nodePseudo/@altova:sDocumentUri)) else (*[n1:Column1/n1:show = 'Y'])[position() = $altova:nodePseudo/@altova:nPos]">
											...
											<xsl:variable name="altova:nCurrElemPos_Level_1_0" select="position()"/>
											<xsl:variable name="altova:CurrGridPos_1" select="$altova:CurrGridPos_1 + count($altova:nodeCurrPseudo/../altova:Element[@altova:sDesignElemId = '4'][position() &lt; $altova:nCurrElemPos_Level_1_0]) * $altova:nColumnWidthTw_1_0"/>
											<xsl:variable name="vvvvvvvvvv" select="$XML/n1:root/n1:ObjectsCollection/n1:Column1/n1:width"/>
											<xsl:text/>
											<xsl:text>\clvertalc</xsl:text>
											<xsl:element name="altova:TableCellColor">
								...
								<xsl:variable name="altova:CurrGridPos_1" select="$altova:CurrGridPos_1 + count($altova:ColumnData/altova:Element[@altova:sDesignElemId = '4']) * $altova:nColumnWidthTw_1_0"/>
								<xsl:for-each select="$altova:CurrContextGrid_3">
									<xsl:variable name="altova:nodesNextPseudo" select="$altova:ColumnData/altova:Element[ @altova:sDesignElemId = 5 ]"/>
									<xsl:for-each select="$altova:CurrContextGrid_3">
										<xsl:for-each select="for $altova:nodePseudo in $altova:nodesNextPseudo return if( exists( $altova:nodePseudo/@altova:sNodeId ) ) then key('altova:id-key',$altova:nodePseudo/@altova:sNodeId,document($altova:nodePseudo/@altova:sDocumentUri)) else (*[n1:Column2/n1:show = 'Y'])[position() = $altova:nodePseudo/@altova:nPos]">
											<xsl:variable name="altova:posCurrPseudo" select="position()"/>
											<xsl:variable name="altova:nodeCurrPseudo" select="$altova:nodesNextPseudo[ $altova:posCurrPseudo ]"/>
											<xsl:variable name="altova:nCurrElemPos_Level_1_0" select="position()"/>
											<xsl:variable name="altova:CurrGridPos_1" select="$altova:CurrGridPos_1 + count($altova:nodeCurrPseudo/../altova:Element[@altova:sDesignElemId = '5'][position() &lt; $altova:nCurrElemPos_Level_1_0]) * $altova:nColumnWidthTw_1_1"/>
											<xsl:text/>
											<xsl:text>\clvertalc</xsl:text>
											<xsl:element name="altova:TableCellColor">
												<xsl:attribute name="altova:sValue" select="'#d9f5ff'"/>
								...
								<xsl:variable name="altova:CurrGridPos_1" select="$altova:CurrGridPos_1 + count($altova:ColumnData/altova:Element[@altova:sDesignElemId = '5']) * $altova:nColumnWidthTw_1_1"/>
								<xsl:for-each select="$altova:CurrContextGrid_3">
									<xsl:variable name="altova:nodesNextPseudo" select="$altova:ColumnData/altova:Element[ @altova:sDesignElemId = 6 ]"/>
									<xsl:for-each select="$altova:CurrContextGrid_3">
										<xsl:for-each select="for $altova:nodePseudo in $altova:nodesNextPseudo return if( exists( $altova:nodePseudo/@altova:sNodeId ) ) then key('altova:id-key',$altova:nodePseudo/@altova:sNodeId,document($altova:nodePseudo/@altova:sDocumentUri)) else (*[n1:Column3/n1:show = 'Y'])[position() = $altova:nodePseudo/@altova:nPos]">
											<xsl:variable name="altova:posCurrPseudo" select="position()"/>
											<xsl:variable name="altova:nodeCurrPseudo" select="$altova:nodesNextPseudo[ $altova:posCurrPseudo ]"/>
											<xsl:variable name="altova:nCurrElemPos_Level_1_0" select="position()"/>
											<xsl:variable name="altova:CurrGridPos_1" select="$altova:CurrGridPos_1 + count($altova:nodeCurrPseudo/../altova:Element[@altova:sDesignElemId = '6'][position() &lt; $altova:nCurrElemPos_Level_1_0]) * $altova:nColumnWidthTw_1_2"/>
											<xsl:text/>
											<xsl:text>\clvertalc</xsl:text>
											<xsl:element name="altova:TableCellColor">
												<xsl:attribute name="altova:sValue" select="'#d9f5ff'"/>
								...
								<xsl:variable name="altova:CurrGridPos_1" select="$altova:CurrGridPos_1 + count($altova:ColumnData/altova:Element[@altova:sDesignElemId = '6']) * $altova:nColumnWidthTw_1_2"/>
								<xsl:for-each select="$altova:CurrContextGrid_3">
									<xsl:variable name="altova:nodesNextPseudo" select="$altova:ColumnData/altova:Element[ @altova:sDesignElemId = 7 ]"/>
									<xsl:for-each select="$altova:CurrContextGrid_3">
										<xsl:for-each select="for $altova:nodePseudo in $altova:nodesNextPseudo return if( exists( $altova:nodePseudo/@altova:sNodeId ) ) then key('altova:id-key',$altova:nodePseudo/@altova:sNodeId,document($altova:nodePseudo/@altova:sDocumentUri)) else (*[n1:Column4/n1:show = 'Y'])[position() = $altova:nodePseudo/@altova:nPos]">
											<xsl:variable name="altova:posCurrPseudo" select="position()"/>
											<xsl:variable name="altova:nodeCurrPseudo" select="$altova:nodesNextPseudo[ $altova:posCurrPseudo ]"/>
											<xsl:variable name="altova:nCurrElemPos_Level_1_0" select="position()"/>
											<xsl:variable name="altova:CurrGridPos_1" select="$altova:CurrGridPos_1 + count($altova:nodeCurrPseudo/../altova:Element[@altova:sDesignElemId = '7'][position() &lt; $altova:nCurrElemPos_Level_1_0]) * $altova:nColumnWidthTw_1_3"/>
											<xsl:text/>
											<xsl:text>\clvertalc</xsl:text>
											<xsl:element name="altova:TableCellColor">
												<xsl:attribute name="altova:sValue" select="'#d9f5ff'"/>
								...
								<xsl:variable name="altova:CurrGridPos_1" select="$altova:CurrGridPos_1 + count($altova:ColumnData/altova:Element[@altova:sDesignElemId = '7']) * $altova:nColumnWidthTw_1_3"/>
								<xsl:for-each select="$altova:CurrContextGrid_3">
									<xsl:variable name="altova:nodesNextPseudo" select="$altova:ColumnData/altova:Element[ @altova:sDesignElemId = 8 ]"/>
									<xsl:for-each select="$altova:CurrContextGrid_3">
										<xsl:for-each select="for $altova:nodePseudo in $altova:nodesNextPseudo return if( exists( $altova:nodePseudo/@altova:sNodeId ) ) then key('altova:id-key',$altova:nodePseudo/@altova:sNodeId,document($altova:nodePseudo/@altova:sDocumentUri)) else (*[n1:Column5/n1:show = 'Y'])[position() = $altova:nodePseudo/@altova:nPos]">
											<xsl:variable name="altova:posCurrPseudo" select="position()"/>
											<xsl:variable name="altova:nodeCurrPseudo" select="$altova:nodesNextPseudo[ $altova:posCurrPseudo ]"/>
											<xsl:variable name="altova:nCurrElemPos_Level_1_0" select="position()"/>
											<xsl:variable name="altova:CurrGridPos_1" select="$altova:CurrGridPos_1 + count($altova:nodeCurrPseudo/../altova:Element[@altova:sDesignElemId = '8'][position() &lt; $altova:nCurrElemPos_Level_1_0]) * $altova:nColumnWidthTw_1_4"/>
											<xsl:text/>
											<xsl:text>\clvertalc</xsl:text>
											<xsl:element name="altova:TableCellColor">
												<xsl:attribute name="altova:sValue" select="'#d9f5ff'"/>
								...
								<xsl:variable name="altova:CurrGridPos_1" select="$altova:CurrGridPos_1 + count($altova:ColumnData/altova:Element[@altova:sDesignElemId = '8']) * $altova:nColumnWidthTw_1_4"/>
								<xsl:for-each select="$altova:CurrContextGrid_3">
									<xsl:variable name="altova:nodesNextPseudo" select="$altova:ColumnData/altova:Element[ @altova:sDesignElemId = 9 ]"/>
									<xsl:for-each select="$altova:CurrContextGrid_3">
										<xsl:for-each select="for $altova:nodePseudo in $altova:nodesNextPseudo return if( exists( $altova:nodePseudo/@altova:sNodeId ) ) then key('altova:id-key',$altova:nodePseudo/@altova:sNodeId,document($altova:nodePseudo/@altova:sDocumentUri)) else (*[n1:Column6/n1:show = 'Y'])[position() = $altova:nodePseudo/@altova:nPos]">
											<xsl:variable name="altova:posCurrPseudo" select="position()"/>
											<xsl:variable name="altova:nodeCurrPseudo" select="$altova:nodesNextPseudo[ $altova:posCurrPseudo ]"/>
											<xsl:variable name="altova:nCurrElemPos_Level_1_0" select="position()"/>
											<xsl:variable name="altova:CurrGridPos_1" select="$altova:CurrGridPos_1 + count($altova:nodeCurrPseudo/../altova:Element[@altova:sDesignElemId = '9'][position() &lt; $altova:nCurrElemPos_Level_1_0]) * $altova:nColumnWidthTw_1_5"/>
											<xsl:text/>
											<xsl:text>\clvertalc</xsl:text>
											<xsl:element name="altova:TableCellColor">
												<xsl:attribute name="altova:sValue" select="'#d9f5ff'"/>
								...
								<xsl:variable name="altova:CurrGridPos_1" select="$altova:CurrGridPos_1 + count($altova:ColumnData/altova:Element[@altova:sDesignElemId = '9']) * $altova:nColumnWidthTw_1_5"/>
								<xsl:for-each select="$altova:CurrContextGrid_3">
									<xsl:variable name="altova:nodesNextPseudo" select="$altova:ColumnData/altova:Element[ @altova:sDesignElemId = 10 ]"/>
									<xsl:for-each select="$altova:CurrContextGrid_3">
										<xsl:for-each select="for $altova:nodePseudo in $altova:nodesNextPseudo return if( exists( $altova:nodePseudo/@altova:sNodeId ) ) then key('altova:id-key',$altova:nodePseudo/@altova:sNodeId,document($altova:nodePseudo/@altova:sDocumentUri)) else (*[n1:Column7/n1:show = 'Y'])[position() = $altova:nodePseudo/@altova:nPos]">
											<xsl:variable name="altova:posCurrPseudo" select="position()"/>
											<xsl:variable name="altova:nodeCurrPseudo" select="$altova:nodesNextPseudo[ $altova:posCurrPseudo ]"/>
											<xsl:variable name="altova:nCurrElemPos_Level_1_0" select="position()"/>
											<xsl:variable name="altova:CurrGridPos_1" select="$altova:CurrGridPos_1 + count($altova:nodeCurrPseudo/../altova:Element[@altova:sDesignElemId = '10'][position() &lt; $altova:nCurrElemPos_Level_1_0]) * $altova:nColumnWidthTw_1_6"/>
											<xsl:text/>
											<xsl:text>\clvertalc</xsl:text>
											<xsl:element name="altova:TableCellColor">
												<xsl:attribute name="altova:sValue" select="'#d9f5ff'"/>
								...
								<xsl:variable name="altova:CurrGridPos_1" select="$altova:CurrGridPos_1 + count($altova:ColumnData/altova:Element[@altova:sDesignElemId = '10']) * $altova:nColumnWidthTw_1_6"/>
								<xsl:for-each select="$altova:CurrContextGrid_3">
									<xsl:variable name="altova:nodesNextPseudo" select="$altova:ColumnData/altova:Element[ @altova:sDesignElemId = 11 ]"/>
									<xsl:for-each select="$altova:CurrContextGrid_3">
										<xsl:for-each select="for $altova:nodePseudo in $altova:nodesNextPseudo return if( exists( $altova:nodePseudo/@altova:sNodeId ) ) then key('altova:id-key',$altova:nodePseudo/@altova:sNodeId,document($altova:nodePseudo/@altova:sDocumentUri)) else (*[n1:Column8/n1:show = 'Y'])[position() = $altova:nodePseudo/@altova:nPos]">
											<xsl:variable name="altova:posCurrPseudo" select="position()"/>
											<xsl:variable name="altova:nodeCurrPseudo" select="$altova:nodesNextPseudo[ $altova:posCurrPseudo ]"/>
											<xsl:variable name="altova:nCurrElemPos_Level_1_0" select="position()"/>
											<xsl:variable name="altova:CurrGridPos_1" select="$altova:CurrGridPos_1 + count($altova:nodeCurrPseudo/../altova:Element[@altova:sDesignElemId = '11'][position() &lt; $altova:nCurrElemPos_Level_1_0]) * $altova:nColumnWidthTw_1_7"/>
											<xsl:text/>
											<xsl:text>\clvertalc</xsl:text>
											<xsl:element name="altova:TableCellColor">
												<xsl:attribute name="altova:sValue" select="'#d9f5ff'"/>
								...
								<xsl:variable name="altova:CurrGridPos_1" select="$altova:CurrGridPos_1 + count($altova:ColumnData/altova:Element[@altova:sDesignElemId = '11']) * $altova:nColumnWidthTw_1_7"/>
								<xsl:for-each select="$altova:CurrContextGrid_3">
									<xsl:variable name="altova:nodesNextPseudo" select="$altova:ColumnData/altova:Element[ @altova:sDesignElemId = 12 ]"/>
									<xsl:for-each select="$altova:CurrContextGrid_3">
										<xsl:for-each select="for $altova:nodePseudo in $altova:nodesNextPseudo return if( exists( $altova:nodePseudo/@altova:sNodeId ) ) then key('altova:id-key',$altova:nodePseudo/@altova:sNodeId,document($altova:nodePseudo/@altova:sDocumentUri)) else (*[n1:Column9/n1:show = 'Y'])[position() = $altova:nodePseudo/@altova:nPos]">
											<xsl:variable name="altova:posCurrPseudo" select="position()"/>
											<xsl:variable name="altova:nodeCurrPseudo" select="$altova:nodesNextPseudo[ $altova:posCurrPseudo ]"/>
											<xsl:variable name="altova:nCurrElemPos_Level_1_0" select="position()"/>
											<xsl:variable name="altova:CurrGridPos_1" select="$altova:CurrGridPos_1 + count($altova:nodeCurrPseudo/../altova:Element[@altova:sDesignElemId = '12'][position() &lt; $altova:nCurrElemPos_Level_1_0]) * $altova:nColumnWidthTw_1_8"/>
											<xsl:text/>
											<xsl:text>\clvertalc</xsl:text>
											<xsl:element name="altova:TableCellColor">
												<xsl:attribute name="altova:sValue" select="'#d9f5ff'"/>
								...
								<xsl:variable name="altova:CurrGridPos_1" select="$altova:CurrGridPos_1 + count($altova:ColumnData/altova:Element[@altova:sDesignElemId = '12']) * $altova:nColumnWidthTw_1_8"/>
								<xsl:for-each select="$altova:CurrContextGrid_3">
									<xsl:variable name="altova:nodesNextPseudo" select="$altova:ColumnData/altova:Element[ @altova:sDesignElemId = 13 ]"/>
									<xsl:for-each select="$altova:CurrContextGrid_3">
										<xsl:for-each select="for $altova:nodePseudo in $altova:nodesNextPseudo return if( exists( $altova:nodePseudo/@altova:sNodeId ) ) then key('altova:id-key',$altova:nodePseudo/@altova:sNodeId,document($altova:nodePseudo/@altova:sDocumentUri)) else (*[n1:Column10/n1:show = 'Y'])[position() = $altova:nodePseudo/@altova:nPos]">
											<xsl:variable name="altova:posCurrPseudo" select="position()"/>
											<xsl:variable name="altova:nodeCurrPseudo" select="$altova:nodesNextPseudo[ $altova:posCurrPseudo ]"/>
											<xsl:variable name="altova:nCurrElemPos_Level_1_0" select="position()"/>
											<xsl:variable name="altova:CurrGridPos_1" select="$altova:CurrGridPos_1 + count($altova:nodeCurrPseudo/../altova:Element[@altova:sDesignElemId = '13'][position() &lt; $altova:nCurrElemPos_Level_1_0]) * $altova:nColumnWidthTw_1_9"/>
											<xsl:text/>
											<xsl:text>\clvertalc</xsl:text>
											<xsl:element name="altova:TableCellColor">
												<xsl:attribute name="altova:sValue" select="'#d9f5ff'"/>
											...
											<xsl:text>\clpadt45\clpadft3</xsl:text>
											<xsl:text>\clpadr45\clpadfr3</xsl:text>
											<xsl:value-of select="if ($altova:nColumnWidthTw_1_9 = $altova:nDefaultColumnWidthTw_1) then '\clftsWidth1' else ()"/>
											<xsl:text>\cellx</xsl:text>
											<xsl:variable name="altova:CurrGridPos_1" select="$altova:CurrGridPos_1 + $altova:nColumnWidthTw_1_9"/>
											<xsl:value-of select="ceiling($altova:CurrGridPos_1)"/>
										</xsl:for-each>
									</xsl:for-each>
								</xsl:for-each>
								<xsl:variable name="altova:CurrGridPos_1" select="$altova:CurrGridPos_1 + count($altova:ColumnData/altova:Element[@altova:sDesignElemId = '13']) * $altova:nColumnWidthTw_1_9"/>
								<xsl:for-each select="$altova:CurrContextGrid_3">
									<xsl:variable name="altova:nodesNextPseudo" select="$altova:ColumnData/altova:Element[ @altova:sDesignElemId = 14 ]"/>
									<xsl:for-each select="$altova:CurrContextGrid_3">
										<xsl:for-each select="for $altova:nodePseudo in $altova:nodesNextPseudo return if( exists( $altova:nodePseudo/@altova:sNodeId ) ) then key('altova:id-key',$altova:nodePseudo/@altova:sNodeId,document($altova:nodePseudo/@altova:sDocumentUri)) else (*[n1:Column11/n1:show = 'Y'])[position() = $altova:nodePseudo/@altova:nPos]">
											<xsl:variable name="altova:posCurrPseudo" select="position()"/>
											<xsl:variable name="altova:nodeCurrPseudo" select="$altova:nodesNextPseudo[ $altova:posCurrPseudo ]"/>
											<xsl:variable name="altova:nCurrElemPos_Level_1_0" select="position()"/>
											<xsl:variable name="altova:CurrGridPos_1" select="$altova:CurrGridPos_1 + count($altova:nodeCurrPseudo/../altova:Element[@altova:sDesignElemId = '14'][position() &lt; $altova:nCurrElemPos_Level_1_0]) * $altova:nColumnWidthTw_1_10"/>
											<xsl:text/>
											<xsl:text>\clvertalc</xsl:text>
											<xsl:element name="altova:TableCellColor">
												<xsl:attribute name="altova:sValue" select="'#d9f5ff'"/>
											...
											<xsl:text>\clpadt45\clpadft3</xsl:text>
											<xsl:text>\clpadr45\clpadfr3</xsl:text>
											<xsl:value-of select="if ($altova:nColumnWidthTw_1_10 = $altova:nDefaultColumnWidthTw_1) then '\clftsWidth1' else ()"/>
											<xsl:text>\cellx</xsl:text>
											<xsl:variable name="altova:CurrGridPos_1" select="$altova:CurrGridPos_1 + $altova:nColumnWidthTw_1_10"/>
											<xsl:value-of select="ceiling($altova:CurrGridPos_1)"/>
										</xsl:for-each>
									</xsl:for-each>
								</xsl:for-each>
								<xsl:variable name="altova:CurrGridPos_1" select="$altova:CurrGridPos_1 + count($altova:ColumnData/altova:Element[@altova:sDesignElemId = '14']) * $altova:nColumnWidthTw_1_10"/>
								<xsl:for-each select="$altova:CurrContextGrid_3">
									<xsl:variable name="altova:nodesNextPseudo" select="$altova:ColumnData/altova:Element[ @altova:sDesignElemId = 15 ]"/>
									<xsl:for-each select="$altova:CurrContextGrid_3">
										<xsl:for-each select="for $altova:nodePseudo in $altova:nodesNextPseudo return if( exists( $altova:nodePseudo/@altova:sNodeId ) ) then key('altova:id-key',$altova:nodePseudo/@altova:sNodeId,document($altova:nodePseudo/@altova:sDocumentUri)) else (*[n1:Column12/n1:show = 'Y'])[position() = $altova:nodePseudo/@altova:nPos]">
											<xsl:variable name="altova:posCurrPseudo" select="position()"/>
											<xsl:variable name="altova:nodeCurrPseudo" select="$altova:nodesNextPseudo[ $altova:posCurrPseudo ]"/>
											<xsl:variable name="altova:nCurrElemPos_Level_1_0" select="position()"/>
											<xsl:variable name="altova:CurrGridPos_1" select="$altova:CurrGridPos_1 + count($altova:nodeCurrPseudo/../altova:Element[@altova:sDesignElemId = '15'][position() &lt; $altova:nCurrElemPos_Level_1_0]) * $altova:nColumnWidthTw_1_11"/>
											<xsl:text/>
											<xsl:text>\clvertalc</xsl:text>
											<xsl:element name="altova:TableCellColor">
												<xsl:attribute name="altova:sValue" select="'#d9f5ff'"/>
											...
											<xsl:text>\clpadt45\clpadft3</xsl:text>
											<xsl:text>\clpadr45\clpadfr3</xsl:text>
											<xsl:value-of select="if ($altova:nColumnWidthTw_1_11 = $altova:nDefaultColumnWidthTw_1) then '\clftsWidth1' else ()"/>
											<xsl:text>\cellx</xsl:text>
											<xsl:variable name="altova:CurrGridPos_1" select="$altova:CurrGridPos_1 + $altova:nColumnWidthTw_1_11"/>
											<xsl:value-of select="ceiling($altova:CurrGridPos_1)"/>
										</xsl:for-each>
									</xsl:for-each>
								</xsl:for-each>
								<xsl:variable name="altova:CurrGridPos_1" select="$altova:CurrGridPos_1 + count($altova:ColumnData/altova:Element[@altova:sDesignElemId = '15']) * $altova:nColumnWidthTw_1_11"/>
								<xsl:for-each select="$altova:CurrContextGrid_3">
									<xsl:variable name="altova:nodesNextPseudo" select="$altova:ColumnData/altova:Element[ @altova:sDesignElemId = 16 ]"/>
									<xsl:for-each select="$altova:CurrContextGrid_3">
										<xsl:for-each select="for $altova:nodePseudo in $altova:nodesNextPseudo return if( exists( $altova:nodePseudo/@altova:sNodeId ) ) then key('altova:id-key',$altova:nodePseudo/@altova:sNodeId,document($altova:nodePseudo/@altova:sDocumentUri)) else (*[n1:Column13/n1:show = 'Y'])[position() = $altova:nodePseudo/@altova:nPos]">
											<xsl:variable name="altova:posCurrPseudo" select="position()"/>
											<xsl:variable name="altova:nodeCurrPseudo" select="$altova:nodesNextPseudo[ $altova:posCurrPseudo ]"/>
											<xsl:variable name="altova:nCurrElemPos_Level_1_0" select="position()"/>
											<xsl:variable name="altova:CurrGridPos_1" select="$altova:CurrGridPos_1 + count($altova:nodeCurrPseudo/../altova:Element[@altova:sDesignElemId = '16'][position() &lt; $altova:nCurrElemPos_Level_1_0]) * $altova:nColumnWidthTw_1_12"/>
											<xsl:text/>
											<xsl:text>\clvertalc</xsl:text>
											<xsl:element name="altova:TableCellColor">
												<xsl:attribute name="altova:sValue" select="'#d9f5ff'"/>
											...
											<xsl:text>\clpadt45\clpadft3</xsl:text>
											<xsl:text>\clpadr45\clpadfr3</xsl:text>
											<xsl:value-of select="if ($altova:nColumnWidthTw_1_12 = $altova:nDefaultColumnWidthTw_1) then '\clftsWidth1' else ()"/>
											<xsl:text>\cellx</xsl:text>
											<xsl:variable name="altova:CurrGridPos_1" select="$altova:CurrGridPos_1 + $altova:nColumnWidthTw_1_12"/>
											<xsl:value-of select="ceiling($altova:CurrGridPos_1)"/>
										</xsl:for-each>
									</xsl:for-each>
								</xsl:for-each>
								<xsl:variable name="altova:CurrGridPos_1" select="$altova:CurrGridPos_1 + count($altova:ColumnData/altova:Element[@altova:sDesignElemId = '16']) * $altova:nColumnWidthTw_1_12"/>
								<xsl:for-each select="$altova:CurrContextGrid_3">
									<xsl:variable name="altova:nodesNextPseudo" select="$altova:ColumnData/altova:Element[ @altova:sDesignElemId = 17 ]"/>
									<xsl:for-each select="$altova:CurrContextGrid_3">
										<xsl:for-each select="for $altova:nodePseudo in $altova:nodesNextPseudo return if( exists( $altova:nodePseudo/@altova:sNodeId ) ) then key('altova:id-key',$altova:nodePseudo/@altova:sNodeId,document($altova:nodePseudo/@altova:sDocumentUri)) else (*[n1:Column14/n1:show = 'Y'])[position() = $altova:nodePseudo/@altova:nPos]">
											<xsl:variable name="altova:posCurrPseudo" select="position()"/>
											<xsl:variable name="altova:nodeCurrPseudo" select="$altova:nodesNextPseudo[ $altova:posCurrPseudo ]"/>
											<xsl:variable name="altova:nCurrElemPos_Level_1_0" select="position()"/>
											<xsl:variable name="altova:CurrGridPos_1" select="$altova:CurrGridPos_1 + count($altova:nodeCurrPseudo/../altova:Element[@altova:sDesignElemId = '17'][position() &lt; $altova:nCurrElemPos_Level_1_0]) * $altova:nColumnWidthTw_1_13"/>
											<xsl:text/>
											<xsl:text>\clvertalc</xsl:text>
											<xsl:element name="altova:TableCellColor">
												<xsl:attribute name="altova:sValue" select="'#d9f5ff'"/>
											...
											<xsl:text>\clpadt45\clpadft3</xsl:text>
											<xsl:text>\clpadr45\clpadfr3</xsl:text>
											<xsl:value-of select="if ($altova:nColumnWidthTw_1_13 = $altova:nDefaultColumnWidthTw_1) then '\clftsWidth1' else ()"/>
											<xsl:text>\cellx</xsl:text>
											<xsl:variable name="altova:CurrGridPos_1" select="$altova:CurrGridPos_1 + $altova:nColumnWidthTw_1_13"/>
											<xsl:value-of select="ceiling($altova:CurrGridPos_1)"/>
										</xsl:for-each>
									</xsl:for-each>
								</xsl:for-each>
								<xsl:variable name="altova:CurrGridPos_1" select="$altova:CurrGridPos_1 + count($altova:ColumnData/altova:Element[@altova:sDesignElemId = '17']) * $altova:nColumnWidthTw_1_13"/>
								<xsl:for-each select="$altova:CurrContextGrid_3">
									<xsl:variable name="altova:nodesNextPseudo" select="$altova:ColumnData/altova:Element[ @altova:sDesignElemId = 18 ]"/>
									<xsl:for-each select="$altova:CurrContextGrid_3">
										<xsl:for-each select="for $altova:nodePseudo in $altova:nodesNextPseudo return if( exists( $altova:nodePseudo/@altova:sNodeId ) ) then key('altova:id-key',$altova:nodePseudo/@altova:sNodeId,document($altova:nodePseudo/@altova:sDocumentUri)) else (*[n1:Column15/n1:show = 'Y'])[position() = $altova:nodePseudo/@altova:nPos]">
											<xsl:variable name="altova:posCurrPseudo" select="position()"/>
											<xsl:variable name="altova:nodeCurrPseudo" select="$altova:nodesNextPseudo[ $altova:posCurrPseudo ]"/>
											<xsl:variable name="altova:nCurrElemPos_Level_1_0" select="position()"/>
											<xsl:variable name="altova:CurrGridPos_1" select="$altova:CurrGridPos_1 + count($altova:nodeCurrPseudo/../altova:Element[@altova:sDesignElemId = '18'][position() &lt; $altova:nCurrElemPos_Level_1_0]) * $altova:nColumnWidthTw_1_14"/>
											<xsl:text/>
											<xsl:text>\clvertalc</xsl:text>
											<xsl:element name="altova:TableCellColor">
												<xsl:attribute name="altova:sValue" select="'#d9f5ff'"/>
											...
											<xsl:text>\clpadt45\clpadft3</xsl:text>
											<xsl:text>\clpadr45\clpadfr3</xsl:text>
											<xsl:value-of select="if ($altova:nColumnWidthTw_1_14 = $altova:nDefaultColumnWidthTw_1) then '\clftsWidth1' else ()"/>
											<xsl:text>\cellx</xsl:text>
											<xsl:variable name="altova:CurrGridPos_1" select="$altova:CurrGridPos_1 + $altova:nColumnWidthTw_1_14"/>
											<xsl:value-of select="ceiling($altova:CurrGridPos_1)"/>
										</xsl:for-each>
									</xsl:for-each>
								</xsl:for-each>
								<xsl:variable name="altova:CurrGridPos_1" select="$altova:CurrGridPos_1 + count($altova:ColumnData/altova:Element[@altova:sDesignElemId = '18']) * $altova:nColumnWidthTw_1_14"/>
								<xsl:for-each select="$altova:CurrContextGrid_3">
									<xsl:variable name="altova:nodesNextPseudo" select="$altova:ColumnData/altova:Element[ @altova:sDesignElemId = 19 ]"/>
									<xsl:for-each select="$altova:CurrContextGrid_3">
										<xsl:for-each select="for $altova:nodePseudo in $altova:nodesNextPseudo return if( exists( $altova:nodePseudo/@altova:sNodeId ) ) then key('altova:id-key',$altova:nodePseudo/@altova:sNodeId,document($altova:nodePseudo/@altova:sDocumentUri)) else (*[n1:Column16/n1:show = 'Y'])[position() = $altova:nodePseudo/@altova:nPos]">
											<xsl:variable name="altova:posCurrPseudo" select="position()"/>
											<xsl:variable name="altova:nodeCurrPseudo" select="$altova:nodesNextPseudo[ $altova:posCurrPseudo ]"/>
											<xsl:variable name="altova:nCurrElemPos_Level_1_0" select="position()"/>
											<xsl:variable name="altova:CurrGridPos_1" select="$altova:CurrGridPos_1 + count($altova:nodeCurrPseudo/../altova:Element[@altova:sDesignElemId = '19'][position() &lt; $altova:nCurrElemPos_Level_1_0]) * $altova:nColumnWidthTw_1_15"/>
											<xsl:text/>
											<xsl:text>\clvertalc</xsl:text>
											<xsl:element name="altova:TableCellColor">
												<xsl:attribute name="altova:sValue" select="'#d9f5ff'"/>
											...
											<xsl:text>\clpadt45\clpadft3</xsl:text>
											<xsl:text>\clpadr45\clpadfr3</xsl:text>
											<xsl:value-of select="if ($altova:nColumnWidthTw_1_15 = $altova:nDefaultColumnWidthTw_1) then '\clftsWidth1' else ()"/>
											<xsl:text>\cellx</xsl:text>
											<xsl:variable name="altova:CurrGridPos_1" select="$altova:CurrGridPos_1 + $altova:nColumnWidthTw_1_15"/>
											<xsl:value-of select="ceiling($altova:CurrGridPos_1)"/>
										</xsl:for-each>
									</xsl:for-each>
								</xsl:for-each>
								<xsl:variable name="altova:CurrGridPos_1" select="$altova:CurrGridPos_1 + count($altova:ColumnData/altova:Element[@altova:sDesignElemId = '19']) * $altova:nColumnWidthTw_1_15"/>
								<xsl:for-each select="$altova:CurrContextGrid_3">
									<xsl:variable name="altova:nodesNextPseudo" select="$altova:ColumnData/altova:Element[ @altova:sDesignElemId = 20 ]"/>
									<xsl:for-each select="$altova:CurrContextGrid_3">
										<xsl:for-each select="for $altova:nodePseudo in $altova:nodesNextPseudo return if( exists( $altova:nodePseudo/@altova:sNodeId ) ) then key('altova:id-key',$altova:nodePseudo/@altova:sNodeId,document($altova:nodePseudo/@altova:sDocumentUri)) else (*[n1:Column17/n1:show = 'Y'])[position() = $altova:nodePseudo/@altova:nPos]">
											<xsl:variable name="altova:posCurrPseudo" select="position()"/>
											<xsl:variable name="altova:nodeCurrPseudo" select="$altova:nodesNextPseudo[ $altova:posCurrPseudo ]"/>
											<xsl:variable name="altova:nCurrElemPos_Level_1_0" select="position()"/>
											<xsl:variable name="altova:CurrGridPos_1" select="$altova:CurrGridPos_1 + count($altova:nodeCurrPseudo/../altova:Element[@altova:sDesignElemId = '20'][position() &lt; $altova:nCurrElemPos_Level_1_0]) * $altova:nColumnWidthTw_1_16"/>
											<xsl:text/>
											<xsl:text>\clvertalc</xsl:text>
											<xsl:element name="altova:TableCellColor">
												<xsl:attribute name="altova:sValue" select="'#d9f5ff'"/>
											...
											<xsl:text>\clpadt45\clpadft3</xsl:text>
											<xsl:text>\clpadr45\clpadfr3</xsl:text>
											<xsl:value-of select="if ($altova:nColumnWidthTw_1_16 = $altova:nDefaultColumnWidthTw_1) then '\clftsWidth1' else ()"/>
											<xsl:text>\cellx</xsl:text>
											<xsl:variable name="altova:CurrGridPos_1" select="$altova:CurrGridPos_1 + $altova:nColumnWidthTw_1_16"/>
											<xsl:value-of select="ceiling($altova:CurrGridPos_1)"/>
										</xsl:for-each>
									</xsl:for-each>
								</xsl:for-each>
								<xsl:variable name="altova:CurrGridPos_1" select="$altova:CurrGridPos_1 + count($altova:ColumnData/altova:Element[@altova:sDesignElemId = '20']) * $altova:nColumnWidthTw_1_16"/>
								<xsl:for-each select="$altova:CurrContextGrid_3">
									<xsl:variable name="altova:nodesNextPseudo" select="$altova:ColumnData/altova:Element[ @altova:sDesignElemId = 21 ]"/>
									<xsl:for-each select="$altova:CurrContextGrid_3">
										<xsl:for-each select="for $altova:nodePseudo in $altova:nodesNextPseudo return if( exists( $altova:nodePseudo/@altova:sNodeId ) ) then key('altova:id-key',$altova:nodePseudo/@altova:sNodeId,document($altova:nodePseudo/@altova:sDocumentUri)) else (*[n1:Column18/n1:show = 'Y'])[position() = $altova:nodePseudo/@altova:nPos]">
											<xsl:variable name="altova:posCurrPseudo" select="position()"/>
											<xsl:variable name="altova:nodeCurrPseudo" select="$altova:nodesNextPseudo[ $altova:posCurrPseudo ]"/>
											<xsl:variable name="altova:nCurrElemPos_Level_1_0" select="position()"/>
											<xsl:variable name="altova:CurrGridPos_1" select="$altova:CurrGridPos_1 + count($altova:nodeCurrPseudo/../altova:Element[@altova:sDesignElemId = '21'][position() &lt; $altova:nCurrElemPos_Level_1_0]) * $altova:nColumnWidthTw_1_17"/>
											<xsl:text/>
											<xsl:text>\clvertalc</xsl:text>
											<xsl:element name="altova:TableCellColor">
												<xsl:attribute name="altova:sValue" select="'#d9f5ff'"/>
											...
											<xsl:text>\clpadt45\clpadft3</xsl:text>
											<xsl:text>\clpadr45\clpadfr3</xsl:text>
											<xsl:value-of select="if ($altova:nColumnWidthTw_1_17 = $altova:nDefaultColumnWidthTw_1) then '\clftsWidth1' else ()"/>
											<xsl:text>\cellx</xsl:text>
											<xsl:variable name="altova:CurrGridPos_1" select="$altova:CurrGridPos_1 + $altova:nColumnWidthTw_1_17"/>
											<xsl:value-of select="ceiling($altova:CurrGridPos_1)"/>
										</xsl:for-each>
									</xsl:for-each>
								</xsl:for-each>
								<xsl:variable name="altova:CurrGridPos_1" select="$altova:CurrGridPos_1 + count($altova:ColumnData/altova:Element[@altova:sDesignElemId = '21']) * $altova:nColumnWidthTw_1_17"/>
								<xsl:for-each select="$altova:CurrContextGrid_3">
									<xsl:variable name="altova:nodesNextPseudo" select="$altova:ColumnData/altova:Element[ @altova:sDesignElemId = 22 ]"/>
									<xsl:for-each select="$altova:CurrContextGrid_3">
										<xsl:for-each select="for $altova:nodePseudo in $altova:nodesNextPseudo return if( exists( $altova:nodePseudo/@altova:sNodeId ) ) then key('altova:id-key',$altova:nodePseudo/@altova:sNodeId,document($altova:nodePseudo/@altova:sDocumentUri)) else (*[n1:Column19/n1:show = 'Y'])[position() = $altova:nodePseudo/@altova:nPos]">
											<xsl:variable name="altova:posCurrPseudo" select="position()"/>
											<xsl:variable name="altova:nodeCurrPseudo" select="$altova:nodesNextPseudo[ $altova:posCurrPseudo ]"/>
											<xsl:variable name="altova:nCurrElemPos_Level_1_0" select="position()"/>
											<xsl:variable name="altova:CurrGridPos_1" select="$altova:CurrGridPos_1 + count($altova:nodeCurrPseudo/../altova:Element[@altova:sDesignElemId = '22'][position() &lt; $altova:nCurrElemPos_Level_1_0]) * $altova:nColumnWidthTw_1_18"/>
											<xsl:text/>
											<xsl:text>\clvertalc</xsl:text>
											<xsl:element name="altova:TableCellColor">
												<xsl:attribute name="altova:sValue" select="'#d9f5ff'"/>
											...
											<xsl:text>\clpadt45\clpadft3</xsl:text>
											<xsl:text>\clpadr45\clpadfr3</xsl:text>
											<xsl:value-of select="if ($altova:nColumnWidthTw_1_18 = $altova:nDefaultColumnWidthTw_1) then '\clftsWidth1' else ()"/>
											<xsl:text>\cellx</xsl:text>
											<xsl:variable name="altova:CurrGridPos_1" select="$altova:CurrGridPos_1 + $altova:nColumnWidthTw_1_18"/>
											<xsl:value-of select="ceiling($altova:CurrGridPos_1)"/>
										</xsl:for-each>
									</xsl:for-each>
								</xsl:for-each>
								<xsl:variable name="altova:CurrGridPos_1" select="$altova:CurrGridPos_1 + count($altova:ColumnData/altova:Element[@altova:sDesignElemId = '22']) * $altova:nColumnWidthTw_1_18"/>
								<xsl:for-each select="$altova:CurrContextGrid_3">
									<xsl:variable name="altova:nodesNextPseudo" select="$altova:ColumnData/altova:Element[ @altova:sDesignElemId = 23 ]"/>
									<xsl:for-each select="$altova:CurrContextGrid_3">
										<xsl:for-each select="for $altova:nodePseudo in $altova:nodesNextPseudo return if( exists( $altova:nodePseudo/@altova:sNodeId ) ) then key('altova:id-key',$altova:nodePseudo/@altova:sNodeId,document($altova:nodePseudo/@altova:sDocumentUri)) else (*[n1:Column20/n1:show = 'Y'])[position() = $altova:nodePseudo/@altova:nPos]">
											<xsl:variable name="altova:posCurrPseudo" select="position()"/>
											<xsl:variable name="altova:nodeCurrPseudo" select="$altova:nodesNextPseudo[ $altova:posCurrPseudo ]"/>
											<xsl:variable name="altova:nCurrElemPos_Level_1_0" select="position()"/>
											<xsl:variable name="altova:CurrGridPos_1" select="$altova:CurrGridPos_1 + count($altova:nodeCurrPseudo/../altova:Element[@altova:sDesignElemId = '23'][position() &lt; $altova:nCurrElemPos_Level_1_0]) * $altova:nColumnWidthTw_1_19"/>
											<xsl:text/>
											<xsl:text>\clvertalc</xsl:text>
											<xsl:element name="altova:TableCellColor">
												<xsl:attribute name="altova:sValue" select="'#d9f5ff'"/>
											...
											<xsl:text>\clpadt45\clpadft3</xsl:text>
											<xsl:text>\clpadr45\clpadfr3</xsl:text>
											<xsl:value-of select="if ($altova:nColumnWidthTw_1_19 = $altova:nDefaultColumnWidthTw_1) then '\clftsWidth1' else ()"/>
											<xsl:text>\cellx</xsl:text>
											<xsl:variable name="altova:CurrGridPos_1" select="$altova:CurrGridPos_1 + $altova:nColumnWidthTw_1_19"/>
											<xsl:value-of select="ceiling($altova:CurrGridPos_1)"/>
										</xsl:for-each>
									</xsl:for-each>
								</xsl:for-each>
								<xsl:variable name="altova:CurrGridPos_1" select="$altova:CurrGridPos_1 + count($altova:ColumnData/altova:Element[@altova:sDesignElemId = '23']) * $altova:nColumnWidthTw_1_19"/>
								<xsl:for-each select="$altova:CurrContextGrid_3">
									<xsl:variable name="altova:nodesNextPseudo" select="$altova:ColumnData/altova:Element[ @altova:sDesignElemId = 24 ]"/>
									<xsl:for-each select="$altova:CurrContextGrid_3">
										<xsl:for-each select="for $altova:nodePseudo in $altova:nodesNextPseudo return if( exists( $altova:nodePseudo/@altova:sNodeId ) ) then key('altova:id-key',$altova:nodePseudo/@altova:sNodeId,document($altova:nodePseudo/@altova:sDocumentUri)) else (*[n1:Column21/n1:show = 'Y'])[position() = $altova:nodePseudo/@altova:nPos]">
											<xsl:variable name="altova:posCurrPseudo" select="position()"/>
											<xsl:variable name="altova:nodeCurrPseudo" select="$altova:nodesNextPseudo[ $altova:posCurrPseudo ]"/>
											<xsl:variable name="altova:nCurrElemPos_Level_1_0" select="position()"/>
											<xsl:variable name="altova:CurrGridPos_1" select="$altova:CurrGridPos_1 + count($altova:nodeCurrPseudo/../altova:Element[@altova:sDesignElemId = '24'][position() &lt; $altova:nCurrElemPos_Level_1_0]) * $altova:nColumnWidthTw_1_20"/>
											<xsl:text/>
											<xsl:text>\clvertalc</xsl:text>
											<xsl:element name="altova:TableCellColor">
												<xsl:attribute name="altova:sValue" select="'#d9f5ff'"/>
											...
											<xsl:text>\clpadt45\clpadft3</xsl:text>
											<xsl:text>\clpadr45\clpadfr3</xsl:text>
											<xsl:value-of select="if ($altova:nColumnWidthTw_1_20 = $altova:nDefaultColumnWidthTw_1) then '\clftsWidth1' else ()"/>
											<xsl:text>\cellx</xsl:text>
											<xsl:variable name="altova:CurrGridPos_1" select="$altova:CurrGridPos_1 + $altova:nColumnWidthTw_1_20"/>
											<xsl:value-of select="ceiling($altova:CurrGridPos_1)"/>
										</xsl:for-each>
									</xsl:for-each>
								</xsl:for-each>
								<xsl:variable name="altova:CurrGridPos_1" select="$altova:CurrGridPos_1 + count($altova:ColumnData/altova:Element[@altova:sDesignElemId = '24']) * $altova:nColumnWidthTw_1_20"/>
								<xsl:for-each select="$altova:CurrContextGrid_3">
									<xsl:variable name="altova:nodesNextPseudo" select="$altova:ColumnData/altova:Element[ @altova:sDesignElemId = 25 ]"/>
									<xsl:for-each select="$altova:CurrContextGrid_3">
										<xsl:for-each select="for $altova:nodePseudo in $altova:nodesNextPseudo return if( exists( $altova:nodePseudo/@altova:sNodeId ) ) then key('altova:id-key',$altova:nodePseudo/@altova:sNodeId,document($altova:nodePseudo/@altova:sDocumentUri)) else (*[n1:Column22/n1:show = 'Y'])[position() = $altova:nodePseudo/@altova:nPos]">
											<xsl:variable name="altova:posCurrPseudo" select="position()"/>
											<xsl:variable name="altova:nodeCurrPseudo" select="$altova:nodesNextPseudo[ $altova:posCurrPseudo ]"/>
											<xsl:variable name="altova:nCurrElemPos_Level_1_0" select="position()"/>
											<xsl:variable name="altova:CurrGridPos_1" select="$altova:CurrGridPos_1 + count($altova:nodeCurrPseudo/../altova:Element[@altova:sDesignElemId = '25'][position() &lt; $altova:nCurrElemPos_Level_1_0]) * $altova:nColumnWidthTw_1_21"/>
											<xsl:text/>
											<xsl:text>\clvertalc</xsl:text>
											<xsl:element name="altova:TableCellColor">
												<xsl:attribute name="altova:sValue" select="'#d9f5ff'"/>
											...
											<xsl:text>\clpadt45\clpadft3</xsl:text>
											<xsl:text>\clpadr45\clpadfr3</xsl:text>
											<xsl:value-of select="if ($altova:nColumnWidthTw_1_21 = $altova:nDefaultColumnWidthTw_1) then '\clftsWidth1' else ()"/>
											<xsl:text>\cellx</xsl:text>
											<xsl:variable name="altova:CurrGridPos_1" select="$altova:CurrGridPos_1 + $altova:nColumnWidthTw_1_21"/>
											<xsl:value-of select="ceiling($altova:CurrGridPos_1)"/>
										</xsl:for-each>
									</xsl:for-each>
								</xsl:for-each>
								<xsl:variable name="altova:CurrGridPos_1" select="$altova:CurrGridPos_1 + count($altova:ColumnData/altova:Element[@altova:sDesignElemId = '25']) * $altova:nColumnWidthTw_1_21"/>
								<xsl:for-each select="$altova:CurrContextGrid_3">
									<xsl:variable name="altova:nodesNextPseudo" select="$altova:ColumnData/altova:Element[ @altova:sDesignElemId = 26 ]"/>
									<xsl:for-each select="$altova:CurrContextGrid_3">
										<xsl:for-each select="for $altova:nodePseudo in $altova:nodesNextPseudo return if( exists( $altova:nodePseudo/@altova:sNodeId ) ) then key('altova:id-key',$altova:nodePseudo/@altova:sNodeId,document($altova:nodePseudo/@altova:sDocumentUri)) else (*[n1:Column23/n1:show = 'Y'])[position() = $altova:nodePseudo/@altova:nPos]">
											<xsl:variable name="altova:posCurrPseudo" select="position()"/>
											<xsl:variable name="altova:nodeCurrPseudo" select="$altova:nodesNextPseudo[ $altova:posCurrPseudo ]"/>
											<xsl:variable name="altova:nCurrElemPos_Level_1_0" select="position()"/>
											<xsl:variable name="altova:CurrGridPos_1" select="$altova:CurrGridPos_1 + count($altova:nodeCurrPseudo/../altova:Element[@altova:sDesignElemId = '26'][position() &lt; $altova:nCurrElemPos_Level_1_0]) * $altova:nColumnWidthTw_1_22"/>
											<xsl:text/>
											<xsl:text>\clvertalc</xsl:text>
											<xsl:element name="altova:TableCellColor">
												<xsl:attribute name="altova:sValue" select="'#d9f5ff'"/>
											...
											<xsl:text>\clpadt45\clpadft3</xsl:text>
											<xsl:text>\clpadr45\clpadfr3</xsl:text>
											<xsl:value-of select="if ($altova:nColumnWidthTw_1_22 = $altova:nDefaultColumnWidthTw_1) then '\clftsWidth1' else ()"/>
											<xsl:text>\cellx</xsl:text>
											<xsl:variable name="altova:CurrGridPos_1" select="$altova:CurrGridPos_1 + $altova:nColumnWidthTw_1_22"/>
											<xsl:value-of select="ceiling($altova:CurrGridPos_1)"/>
										</xsl:for-each>
									</xsl:for-each>
								</xsl:for-each>
								<xsl:variable name="altova:CurrGridPos_1" select="$altova:CurrGridPos_1 + count($altova:ColumnData/altova:Element[@altova:sDesignElemId = '26']) * $altova:nColumnWidthTw_1_22"/>
								<xsl:for-each select="$altova:CurrContextGrid_3">
									<xsl:variable name="altova:nodesNextPseudo" select="$altova:ColumnData/altova:Element[ @altova:sDesignElemId = 27 ]"/>
									<xsl:for-each select="$altova:CurrContextGrid_3">
										<xsl:for-each select="for $altova:nodePseudo in $altova:nodesNextPseudo return if( exists( $altova:nodePseudo/@altova:sNodeId ) ) then key('altova:id-key',$altova:nodePseudo/@altova:sNodeId,document($altova:nodePseudo/@altova:sDocumentUri)) else (*[n1:Column24/n1:show = 'Y'])[position() = $altova:nodePseudo/@altova:nPos]">
											<xsl:variable name="altova:posCurrPseudo" select="position()"/>
											<xsl:variable name="altova:nodeCurrPseudo" select="$altova:nodesNextPseudo[ $altova:posCurrPseudo ]"/>
											<xsl:variable name="altova:nCurrElemPos_Level_1_0" select="position()"/>
											<xsl:variable name="altova:CurrGridPos_1" select="$altova:CurrGridPos_1 + count($altova:nodeCurrPseudo/../altova:Element[@altova:sDesignElemId = '27'][position() &lt; $altova:nCurrElemPos_Level_1_0]) * $altova:nColumnWidthTw_1_23"/>
											<xsl:text/>
											<xsl:text>\clvertalc</xsl:text>
											<xsl:element name="altova:TableCellColor">
												<xsl:attribute name="altova:sValue" select="'#d9f5ff'"/>
											...
											<xsl:text>\clpadt45\clpadft3</xsl:text>
											<xsl:text>\clpadr45\clpadfr3</xsl:text>
											<xsl:value-of select="if ($altova:nColumnWidthTw_1_23 = $altova:nDefaultColumnWidthTw_1) then '\clftsWidth1' else ()"/>
											<xsl:text>\cellx</xsl:text>
											<xsl:variable name="altova:CurrGridPos_1" select="$altova:CurrGridPos_1 + $altova:nColumnWidthTw_1_23"/>
											<xsl:value-of select="ceiling($altova:CurrGridPos_1)"/>
										</xsl:for-each>
									</xsl:for-each>
								</xsl:for-each>
								<xsl:variable name="altova:CurrGridPos_1" select="$altova:CurrGridPos_1 + count($altova:ColumnData/altova:Element[@altova:sDesignElemId = '27']) * $altova:nColumnWidthTw_1_23"/>
								<xsl:for-each select="$altova:CurrContextGrid_3">
									<xsl:variable name="altova:nodesNextPseudo" select="$altova:ColumnData/altova:Element[ @altova:sDesignElemId = 28 ]"/>
									<xsl:for-each select="$altova:CurrContextGrid_3">
										<xsl:for-each select="for $altova:nodePseudo in $altova:nodesNextPseudo return if( exists( $altova:nodePseudo/@altova:sNodeId ) ) then key('altova:id-key',$altova:nodePseudo/@altova:sNodeId,document($altova:nodePseudo/@altova:sDocumentUri)) else (*[n1:Column25/n1:show = 'Y'])[position() = $altova:nodePseudo/@altova:nPos]">
											<xsl:variable name="altova:posCurrPseudo" select="position()"/>
											<xsl:variable name="altova:nodeCurrPseudo" select="$altova:nodesNextPseudo[ $altova:posCurrPseudo ]"/>
											<xsl:variable name="altova:nCurrElemPos_Level_1_0" select="position()"/>
											<xsl:variable name="altova:CurrGridPos_1" select="$altova:CurrGridPos_1 + count($altova:nodeCurrPseudo/../altova:Element[@altova:sDesignElemId = '28'][position() &lt; $altova:nCurrElemPos_Level_1_0]) * $altova:nColumnWidthTw_1_24"/>
											<xsl:text/>
											<xsl:text>\clvertalc</xsl:text>
											<xsl:element name="altova:TableCellColor">
												<xsl:attribute name="altova:sValue" select="'#d9f5ff'"/>
											...
											<xsl:text>\clpadt45\clpadft3</xsl:text>
											<xsl:text>\clpadr45\clpadfr3</xsl:text>
											<xsl:value-of select="if ($altova:nColumnWidthTw_1_24 = $altova:nDefaultColumnWidthTw_1) then '\clftsWidth1' else ()"/>
											<xsl:text>\cellx</xsl:text>
											<xsl:variable name="altova:CurrGridPos_1" select="$altova:CurrGridPos_1 + $altova:nColumnWidthTw_1_24"/>
											<xsl:value-of select="ceiling($altova:CurrGridPos_1)"/>
										</xsl:for-each>
									</xsl:for-each>
								</xsl:for-each>
								<xsl:variable name="altova:CurrGridPos_1" select="$altova:CurrGridPos_1 + count($altova:ColumnData/altova:Element[@altova:sDesignElemId = '28']) * $altova:nColumnWidthTw_1_24"/>
								<xsl:for-each select="$altova:CurrContextGrid_3">
									<xsl:variable name="altova:nodesNextPseudo" select="$altova:ColumnData/altova:Element[ @altova:sDesignElemId = 29 ]"/>
									<xsl:for-each select="$altova:CurrContextGrid_3">
										<xsl:for-each select="for $altova:nodePseudo in $altova:nodesNextPseudo return if( exists( $altova:nodePseudo/@altova:sNodeId ) ) then key('altova:id-key',$altova:nodePseudo/@altova:sNodeId,document($altova:nodePseudo/@altova:sDocumentUri)) else (*[n1:Column26/n1:show = 'Y'])[position() = $altova:nodePseudo/@altova:nPos]">
											<xsl:variable name="altova:posCurrPseudo" select="position()"/>
											<xsl:variable name="altova:nodeCurrPseudo" select="$altova:nodesNextPseudo[ $altova:posCurrPseudo ]"/>
											<xsl:variable name="altova:nCurrElemPos_Level_1_0" select="position()"/>
											<xsl:variable name="altova:CurrGridPos_1" select="$altova:CurrGridPos_1 + count($altova:nodeCurrPseudo/../altova:Element[@altova:sDesignElemId = '29'][position() &lt; $altova:nCurrElemPos_Level_1_0]) * $altova:nColumnWidthTw_1_25"/>
											<xsl:text/>
											<xsl:text>\clvertalc</xsl:text>
											<xsl:element name="altova:TableCellColor">
												<xsl:attribute name="altova:sValue" select="'#d9f5ff'"/>
											...
											<xsl:text>\clpadt45\clpadft3</xsl:text>
											<xsl:text>\clpadr45\clpadfr3</xsl:text>
											<xsl:value-of select="if ($altova:nColumnWidthTw_1_25 = $altova:nDefaultColumnWidthTw_1) then '\clftsWidth1' else ()"/>
											<xsl:text>\cellx</xsl:text>
											<xsl:variable name="altova:CurrGridPos_1" select="$altova:CurrGridPos_1 + $altova:nColumnWidthTw_1_25"/>
											<xsl:value-of select="ceiling($altova:CurrGridPos_1)"/>
										</xsl:for-each>
									</xsl:for-each>
								</xsl:for-each>
								<xsl:variable name="altova:CurrGridPos_1" select="$altova:CurrGridPos_1 + count($altova:ColumnData/altova:Element[@altova:sDesignElemId = '29']) * $altova:nColumnWidthTw_1_25"/>
								<xsl:for-each select="$altova:CurrContextGrid_3">
									<xsl:variable name="altova:nodesNextPseudo" select="$altova:ColumnData/altova:Element[ @altova:sDesignElemId = 30 ]"/>
									<xsl:for-each select="$altova:CurrContextGrid_3">
										<xsl:for-each select="for $altova:nodePseudo in $altova:nodesNextPseudo return if( exists( $altova:nodePseudo/@altova:sNodeId ) ) then key('altova:id-key',$altova:nodePseudo/@altova:sNodeId,document($altova:nodePseudo/@altova:sDocumentUri)) else (*[n1:Column27/n1:show = 'Y'])[position() = $altova:nodePseudo/@altova:nPos]">
											<xsl:variable name="altova:posCurrPseudo" select="position()"/>
											<xsl:variable name="altova:nodeCurrPseudo" select="$altova:nodesNextPseudo[ $altova:posCurrPseudo ]"/>
											<xsl:variable name="altova:nCurrElemPos_Level_1_0" select="position()"/>
											<xsl:variable name="altova:CurrGridPos_1" select="$altova:CurrGridPos_1 + count($altova:nodeCurrPseudo/../altova:Element[@altova:sDesignElemId = '30'][position() &lt; $altova:nCurrElemPos_Level_1_0]) * $altova:nColumnWidthTw_1_26"/>
											<xsl:text/>
											<xsl:text>\clvertalc</xsl:text>
											<xsl:element name="altova:TableCellColor">
												<xsl:attribute name="altova:sValue" select="'#d9f5ff'"/>
											...
											<xsl:text>\clpadt45\clpadft3</xsl:text>
											<xsl:text>\clpadr45\clpadfr3</xsl:text>
											<xsl:value-of select="if ($altova:nColumnWidthTw_1_26 = $altova:nDefaultColumnWidthTw_1) then '\clftsWidth1' else ()"/>
											<xsl:text>\cellx</xsl:text>
											<xsl:variable name="altova:CurrGridPos_1" select="$altova:CurrGridPos_1 + $altova:nColumnWidthTw_1_26"/>
											<xsl:value-of select="ceiling($altova:CurrGridPos_1)"/>
										</xsl:for-each>
									</xsl:for-each>
								</xsl:for-each>
								<xsl:variable name="altova:CurrGridPos_1" select="$altova:CurrGridPos_1 + count($altova:ColumnData/altova:Element[@altova:sDesignElemId = '30']) * $altova:nColumnWidthTw_1_26"/>
								<xsl:for-each select="$altova:CurrContextGrid_3">
									<xsl:variable name="altova:nodesNextPseudo" select="$altova:ColumnData/altova:Element[ @altova:sDesignElemId = 31 ]"/>
									<xsl:for-each select="$altova:CurrContextGrid_3">
										<xsl:for-each select="for $altova:nodePseudo in $altova:nodesNextPseudo return if( exists( $altova:nodePseudo/@altova:sNodeId ) ) then key('altova:id-key',$altova:nodePseudo/@altova:sNodeId,document($altova:nodePseudo/@altova:sDocumentUri)) else (*[n1:Column28/n1:show = 'Y'])[position() = $altova:nodePseudo/@altova:nPos]">
											<xsl:variable name="altova:posCurrPseudo" select="position()"/>
											<xsl:variable name="altova:nodeCurrPseudo" select="$altova:nodesNextPseudo[ $altova:posCurrPseudo ]"/>
											<xsl:variable name="altova:nCurrElemPos_Level_1_0" select="position()"/>
											<xsl:variable name="altova:CurrGridPos_1" select="$altova:CurrGridPos_1 + count($altova:nodeCurrPseudo/../altova:Element[@altova:sDesignElemId = '31'][position() &lt; $altova:nCurrElemPos_Level_1_0]) * $altova:nColumnWidthTw_1_27"/>
											<xsl:text/>
											<xsl:text>\clvertalc</xsl:text>
											<xsl:element name="altova:TableCellColor">
												<xsl:attribute name="altova:sValue" select="'#d9f5ff'"/>
											...
											<xsl:text>\clpadt45\clpadft3</xsl:text>
											<xsl:text>\clpadr45\clpadfr3</xsl:text>
											<xsl:value-of select="if ($altova:nColumnWidthTw_1_27 = $altova:nDefaultColumnWidthTw_1) then '\clftsWidth1' else ()"/>
											<xsl:text>\cellx</xsl:text>
											<xsl:variable name="altova:CurrGridPos_1" select="$altova:CurrGridPos_1 + $altova:nColumnWidthTw_1_27"/>
											<xsl:value-of select="ceiling($altova:CurrGridPos_1)"/>
										</xsl:for-each>
									</xsl:for-each>
								</xsl:for-each>
								<xsl:variable name="altova:CurrGridPos_1" select="$altova:CurrGridPos_1 + count($altova:ColumnData/altova:Element[@altova:sDesignElemId = '31']) * $altova:nColumnWidthTw_1_27"/>
								<xsl:for-each select="$altova:CurrContextGrid_3">
									<xsl:variable name="altova:nodesNextPseudo" select="$altova:ColumnData/altova:Element[ @altova:sDesignElemId = 32 ]"/>
									<xsl:for-each select="$altova:CurrContextGrid_3">
										<xsl:for-each select="for $altova:nodePseudo in $altova:nodesNextPseudo return if( exists( $altova:nodePseudo/@altova:sNodeId ) ) then key('altova:id-key',$altova:nodePseudo/@altova:sNodeId,document($altova:nodePseudo/@altova:sDocumentUri)) else (*[n1:Column29/n1:show = 'Y'])[position() = $altova:nodePseudo/@altova:nPos]">
											<xsl:variable name="altova:posCurrPseudo" select="position()"/>
											<xsl:variable name="altova:nodeCurrPseudo" select="$altova:nodesNextPseudo[ $altova:posCurrPseudo ]"/>
											<xsl:variable name="altova:nCurrElemPos_Level_1_0" select="position()"/>
											<xsl:variable name="altova:CurrGridPos_1" select="$altova:CurrGridPos_1 + count($altova:nodeCurrPseudo/../altova:Element[@altova:sDesignElemId = '32'][position() &lt; $altova:nCurrElemPos_Level_1_0]) * $altova:nColumnWidthTw_1_28"/>
											<xsl:text/>
											<xsl:text>\clvertalc</xsl:text>
											<xsl:element name="altova:TableCellColor">
												<xsl:attribute name="altova:sValue" select="'#d9f5ff'"/>
											...
											<xsl:text>\clpadt45\clpadft3</xsl:text>
											<xsl:text>\clpadr45\clpadfr3</xsl:text>
											<xsl:value-of select="if ($altova:nColumnWidthTw_1_28 = $altova:nDefaultColumnWidthTw_1) then '\clftsWidth1' else ()"/>
											<xsl:text>\cellx</xsl:text>
											<xsl:variable name="altova:CurrGridPos_1" select="$altova:CurrGridPos_1 + $altova:nColumnWidthTw_1_28"/>
											<xsl:value-of select="ceiling($altova:CurrGridPos_1)"/>
										</xsl:for-each>
									</xsl:for-each>
								</xsl:for-each>
								<xsl:variable name="altova:CurrGridPos_1" select="$altova:CurrGridPos_1 + count($altova:ColumnData/altova:Element[@altova:sDesignElemId = '32']) * $altova:nColumnWidthTw_1_28"/>
								<xsl:for-each select="$altova:CurrContextGrid_3">
									<xsl:variable name="altova:nodesNextPseudo" select="$altova:ColumnData/altova:Element[ @altova:sDesignElemId = 33 ]"/>
									<xsl:for-each select="$altova:CurrContextGrid_3">
										<xsl:for-each select="for $altova:nodePseudo in $altova:nodesNextPseudo return if( exists( $altova:nodePseudo/@altova:sNodeId ) ) then key('altova:id-key',$altova:nodePseudo/@altova:sNodeId,document($altova:nodePseudo/@altova:sDocumentUri)) else (*[n1:Column30/n1:show = 'Y'])[position() = $altova:nodePseudo/@altova:nPos]">
											<xsl:variable name="altova:posCurrPseudo" select="position()"/>
											<xsl:variable name="altova:nodeCurrPseudo" select="$altova:nodesNextPseudo[ $altova:posCurrPseudo ]"/>
											<xsl:variable name="altova:nCurrElemPos_Level_1_0" select="position()"/>
											<xsl:variable name="altova:CurrGridPos_1" select="$altova:CurrGridPos_1 + count($altova:nodeCurrPseudo/../altova:Element[@altova:sDesignElemId = '33'][position() &lt; $altova:nCurrElemPos_Level_1_0]) * $altova:nColumnWidthTw_1_29"/>
											<xsl:text/>
											<xsl:text>\clvertalc</xsl:text>
											<xsl:element name="altova:TableCellColor">
												<xsl:attribute name="altova:sValue" select="'#d9f5ff'"/>
											...
											<xsl:text>\clpadt45\clpadft3</xsl:text>
											<xsl:text>\clpadr45\clpadfr3</xsl:text>
											<xsl:value-of select="if ($altova:nColumnWidthTw_1_29 = $altova:nDefaultColumnWidthTw_1) then '\clftsWidth1' else ()"/>
											<xsl:text>\cellx</xsl:text>
											<xsl:variable name="altova:CurrGridPos_1" select="$altova:CurrGridPos_1 + $altova:nColumnWidthTw_1_29"/>
											<xsl:value-of select="ceiling($altova:CurrGridPos_1)"/>
										</xsl:for-each>
									</xsl:for-each>
								</xsl:for-each>
								<xsl:variable name="altova:CurrGridPos_1" select="$altova:CurrGridPos_1 + count($altova:ColumnData/altova:Element[@altova:sDesignElemId = '33']) * $altova:nColumnWidthTw_1_29"/>
							</xsl:variable>
							<xsl:if test="$templatetablelevel + 1 = 1">
...
$v_Property1_Value
	...
	<xsl:variable name="altova:seqRichEditStyleFonts" select="altova:GetFontsFromRichEditStyles($altova:DocumentMonolith)"/>
	<xsl:variable name="altova:seqFontsInUse" select="distinct-values(($altova:non-xpath-fonts-in-use, $altova:DocumentMonolith//@font-family, $altova:seqRichEditStyleFonts))[. != '']"/>
	<xsl:variable name="altova:seqRichEditStyleColors" select="altova:GetColorsFromRichEditStyles($altova:DocumentMonolith)"/>
	<xsl:variable name="altova:seqColorsInUseNotNormalizedNotValidated" select="($altova:non-xpath-colors-in-use, $altova:DocumentMonolith//(@color | @background-color | @border-color | @border-top-color | @border-bottom-color | @border-left-color | @border-right-color | altova:BorderColor/@altova:sValue | altova:TableCellColor/@altova:sValue), $altova:seqRichEditStyleColors)" as="xs:string*"/>
	...
	<xsl:template match="altova:paragraph" mode="altova:rtf">
		...
		<!-- Paragraph styles (from containing text block) styles applied via RichEdit -->
		<xsl:if test="ancestor::altova:text-block/@altova:sRichEditStyles">
			<xsl:variable name="altova:sTextAlign" select="ancestor::altova:text-block/@altova:sRichEditStyles[contains(., 'text-align')][1]" as="xs:string?"/>
			<xsl:if test="$altova:sTextAlign">
				<xsl:value-of select="altova:GenerateRtfRichEditParagraphStyles(string($altova:sTextAlign))"/>
			</xsl:if>
		</xsl:if>
		...
		<!-- RichEdit styles (paragraph) from the paragraph itself -->
		<xsl:if test="@altova:sRichEditStyles">
			<xsl:variable name="altova:sTextAlign" select="@altova:sRichEditStyles[contains(., 'text-align')]" as="xs:string?"/>
			<xsl:if test="$altova:sTextAlign">
				<xsl:value-of select="altova:GenerateRtfRichEditParagraphStyles(string($altova:sTextAlign))"/>
			</xsl:if>
		</xsl:if>
		<!-- Character styles -->
		<!--
		Character properties (e.g. from RichEdit) must not be inherited by the following paragraphs, so enclose them in a group.
		...
		<!-- RichEdit styles (character) from the paragraph itself -->
		<xsl:if test="@altova:sRichEditStyles">
			<xsl:value-of select="altova:GenerateRtfRichEditCharacterStyles(string(@altova:sRichEditStyles))"/>
		</xsl:if>
		<!-- Paragraph contents -->
		<xsl:apply-templates mode="altova:rtf"/>
		<!--
	...
	<xsl:template match="altova:table-cell" mode="altova:rtf">
		...
		<!-- Character styles -->
		<xsl:variable name="altova:bCharacterStylesPresent" select="@altova:character-styles or @color or @font-family or @altova:sRichEditStyles or @altova:DynamicClassSelector"/>
	...
	<xsl:function name="altova:GenerateRtfRichEditCharacterStyles" as="xs:string?">
	...
	<xsl:function name="altova:GenerateRtfRichEditParagraphStyles" as="xs:string?">
		<xsl:param name="altova:sStyleList" as="xs:string?"/>
		<xsl:variable name="altova:seqStyles" select="tokenize($altova:sStyleList, ';')" as="xs:string*"/>
		<xsl:variable name="altova:seqControlWords" as="xs:string*">
			<xsl:for-each select="$altova:seqStyles">
	...
	<xsl:function name="altova:GetColorsFromRichEditStyles">
		<xsl:param name="altova:RootNode"/>
		<xsl:variable name="altova:seqStyleLists" select="$altova:RootNode//@altova:sRichEditStyles" as="xs:string*"/>
		<xsl:variable name="altova:seqStyles" select="for $StyleList in $altova:seqStyleLists return tokenize($StyleList, ';')" as="xs:string*"/>
		<xsl:variable name="altova:seqRichEditStyleColors" select="for $Style in $altova:seqStyles return if (index-of(('color', 'background-color'), normalize-space(substring-before($Style, ':')))) then normalize-space(substring-after($Style, ':')) else ()"/>
		<xsl:sequence select="$altova:seqRichEditStyleColors"/>
	</xsl:function>
	<xsl:function name="altova:GetFontsFromRichEditStyles">
		<xsl:param name="altova:RootNode"/>
		<xsl:variable name="altova:seqStyleLists" select="$altova:RootNode//@altova:sRichEditStyles" as="xs:string*"/>
		<xsl:variable name="altova:seqStyles" select="for $StyleList in $altova:seqStyleLists return tokenize($StyleList, ';')" as="xs:string*"/>
		<xsl:variable name="altova:seqRichEditStyleFonts" select="for $Style in $altova:seqStyles return if (normalize-space(substring-before($Style, ':')) eq 'font-family') then normalize-space(substring-after($Style, ':')) else ()"/>
		<xsl:sequence select="$altova:seqRichEditStyleFonts"/>
	</xsl:function>

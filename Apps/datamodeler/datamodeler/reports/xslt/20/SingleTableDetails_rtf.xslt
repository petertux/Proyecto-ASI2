...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:altova="http://www.altova.com" xmlns:altovaext="http://www.altova.com/xslt-extensions" xmlns:clitype="clitype" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:iso4217="http://www.xbrl.org/2003/iso4217" xmlns:ix="http://www.xbrl.org/2008/inlineXBRL" xmlns:java="java" xmlns:link="http://www.xbrl.org/2003/linkbase" xmlns:n1="osdm_t" xmlns:sps="http://www.altova.com/StyleVision/user-xpath-functions" xmlns:xbrldi="http://xbrl.org/2006/xbrldi" xmlns:xbrli="http://www.xbrl.org/2003/instance" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" exclude-result-prefixes="#all">
	...
	<xsl:variable name="altova:DocumentMonolith">
		<altova:Document altova:Url="{if ($SV_BaseOutputFileName) then concat($SV_BaseOutputFileName,'.rtf') else ''}">
			...
			<xsl:call-template name="altova:Section_0A8299F8_FooterLeft"/>
			<xsl:text>}</xsl:text>
			<xsl:text>{</xsl:text>
			<xsl:text>\footerr </xsl:text>
			<xsl:call-template name="altova:Section_0A8299F8_FooterRight"/>
			<xsl:text>}</xsl:text>
						...
						<altova:table>
							...
							<altova:table-row>
								<xsl:variable name="altova:RowStyle">
									...
									<xsl:text>\clpadt45\clpadft3</xsl:text>
									<xsl:text>\clpadr45\clpadfr3</xsl:text>
									<xsl:value-of select="if ($altova:nColumnWidthTw_5_7 = $altova:nDefaultColumnWidthTw_5) then '\clftsWidth1' else ()"/>
									<xsl:text>\cellx</xsl:text>
									<xsl:variable name="altova:CurrGridPos_5" select="$altova:CurrGridPos_5 + $altova:nColumnWidthTw_5_7"/>
									<xsl:value-of select="ceiling($altova:CurrGridPos_5)"/>
									<xsl:text/>
									<xsl:text>\clvertalc</xsl:text>
									<xsl:element name="altova:TableCellColor">
									...
									<xsl:text>\clpadt45\clpadft3</xsl:text>
									<xsl:text>\clpadr45\clpadfr3</xsl:text>
									<xsl:value-of select="if ($altova:nColumnWidthTw_5_8 = $altova:nDefaultColumnWidthTw_5) then '\clftsWidth1' else ()"/>
									<xsl:text>\cellx</xsl:text>
									<xsl:variable name="altova:CurrGridPos_5" select="$altova:CurrGridPos_5 + $altova:nColumnWidthTw_5_8"/>
									<xsl:value-of select="ceiling($altova:CurrGridPos_5)"/>
									<xsl:text/>
									<xsl:text>\clvertalc</xsl:text>
									<xsl:element name="altova:TableCellColor">
									...
									<xsl:text>\clpadt45\clpadft3</xsl:text>
									<xsl:text>\clpadr45\clpadfr3</xsl:text>
									<xsl:value-of select="if ($altova:nColumnWidthTw_5_9 = $altova:nDefaultColumnWidthTw_5) then '\clftsWidth1' else ()"/>
									<xsl:text>\cellx</xsl:text>
									<xsl:variable name="altova:CurrGridPos_5" select="$altova:CurrGridPos_5 + $altova:nColumnWidthTw_5_9"/>
									<xsl:value-of select="ceiling($altova:CurrGridPos_5)"/>
									<xsl:text/>
									<xsl:text>\clvertalc</xsl:text>
									<xsl:element name="altova:TableCellColor">
									...
									<xsl:text>\clpadt45\clpadft3</xsl:text>
									<xsl:text>\clpadr45\clpadfr3</xsl:text>
									<xsl:value-of select="if ($altova:nColumnWidthTw_5_10 = $altova:nDefaultColumnWidthTw_5) then '\clftsWidth1' else ()"/>
									<xsl:text>\cellx</xsl:text>
									<xsl:variable name="altova:CurrGridPos_5" select="$altova:CurrGridPos_5 + $altova:nColumnWidthTw_5_10"/>
									<xsl:value-of select="ceiling($altova:CurrGridPos_5)"/>
								</xsl:variable>
								<xsl:if test="$templatetablelevel + 1 = 1">
	...
	<xsl:template name="altova:Section_0A8299F8_FooterRight">
		<xsl:variable name="altova:nMaxWidthIn" select="10.13"/>
		<xsl:variable name="templatetablelevel" select="0"/>
	...
	<xsl:template name="altova:Section_0A8299F8_FooterLeft">
		<xsl:variable name="altova:nMaxWidthIn" select="10.13"/>
		<xsl:variable name="templatetablelevel" select="0"/>
		<xsl:variable name="altova:CurrContextGrid_081520F8" select="."/>
		<xsl:variable name="altova:ColumnData">

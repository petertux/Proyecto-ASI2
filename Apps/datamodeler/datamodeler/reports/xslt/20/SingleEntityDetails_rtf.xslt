...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:altova="http://www.altova.com" xmlns:altovaext="http://www.altova.com/xslt-extensions" xmlns:clitype="clitype" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:iso4217="http://www.xbrl.org/2003/iso4217" xmlns:ix="http://www.xbrl.org/2008/inlineXBRL" xmlns:java="java" xmlns:link="http://www.xbrl.org/2003/linkbase" xmlns:n1="osdm_e" xmlns:sps="http://www.altova.com/StyleVision/user-xpath-functions" xmlns:xbrldi="http://xbrl.org/2006/xbrldi" xmlns:xbrli="http://www.xbrl.org/2003/instance" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" exclude-result-prefixes="#all">
	...
	<xsl:variable name="altova:DocumentMonolith">
		<altova:Document altova:Url="{if ($SV_BaseOutputFileName) then concat($SV_BaseOutputFileName,'.rtf') else ''}">
			...
			<xsl:call-template name="altova:Section_0832A960_FooterLeft"/>
			<xsl:text>}</xsl:text>
			<xsl:text>{</xsl:text>
			<xsl:text>\footerr </xsl:text>
			<xsl:call-template name="altova:Section_0832A960_FooterRight"/>
			<xsl:text>}</xsl:text>
			...
			<xsl:for-each select="$XML">
				<xsl:for-each select="n1:root">
					<altova:new-line/>
					<altova:new-line/>
					<xsl:variable name="altova:CurrContextGrid_08331D40" select="."/>
					...
					<xsl:variable name="altova:CurrContextGrid_0A6C9888" select="."/>
					<xsl:variable name="altova:ColumnData">
						<altova:Internal/>
					</xsl:variable>
					<altova:table>
						...
						<altova:table-row>
							...
							<altova:table-cell altova:paragraph-styles="\sl0">
								<xsl:variable name="altova:CurrContextGrid_0A6C9D78" select="."/>
								<xsl:variable name="altova:ColumnData">
									<altova:Internal/>
								</xsl:variable>
								<altova:table>
							...
							<altova:table-cell altova:character-styles="\fs16" altova:character-reset-styles="\fs24" altova:paragraph-styles="\sl0">
								<xsl:if test="count( n1:MappedTablesCollection )">
									...
									<altova:new-line/>
									<xsl:variable name="altova:CurrContextGrid_0840DF88" select="."/>
									<xsl:variable name="altova:ColumnData">
										<altova:Internal/>
									</xsl:variable>
									<altova:table>
					...
					<xsl:if test="count( n1:DescriptionNotes )">
						...
						<xsl:for-each select="n1:DescriptionNotes">
							<xsl:variable name="altova:CurrContextGrid_084691A0" select="."/>
							<xsl:variable name="altova:ColumnData">
								<altova:Internal/>
							</xsl:variable>
							<altova:table>
					...
					<xsl:if test="count( n1:QuantitativeInfoCollection )">
						...
						<xsl:for-each select="n1:QuantitativeInfoCollection">
							<xsl:variable name="altova:CurrContextGrid_0A7999F0" select="."/>
							<xsl:variable name="altova:ColumnData">
								<altova:Internal/>
							</xsl:variable>
							<altova:table>
					...
					<xsl:if test="count( n1:DiagramsCollection)">
						...
						<altova:new-line/>
						<xsl:variable name="altova:CurrContextGrid_0A945E98" select="."/>
						<xsl:variable name="altova:ColumnData">
							<altova:Internal/>
						</xsl:variable>
						<altova:table>
					...
					<xsl:if test="count( n1:AttributesCollection )">
						...
						<xsl:variable name="altova:CurrContextGrid_09D17608" select="."/>
						<xsl:variable name="altova:ColumnData">
							<altova:Internal/>
						</xsl:variable>
						<altova:table>
							...
							<altova:table-row>
								<xsl:variable name="altova:RowStyle">
									...
									<xsl:text>\clpadt45\clpadft3</xsl:text>
									<xsl:text>\clpadr45\clpadfr3</xsl:text>
									<xsl:value-of select="if ($altova:nColumnWidthTw_7_4 = $altova:nDefaultColumnWidthTw_7) then '\clftsWidth1' else ()"/>
									<xsl:text>\cellx</xsl:text>
									<xsl:variable name="altova:CurrGridPos_7" select="$altova:CurrGridPos_7 + $altova:nColumnWidthTw_7_4"/>
									<xsl:value-of select="ceiling($altova:CurrGridPos_7)"/>
									<xsl:text/>
									<xsl:text>\clvertalc</xsl:text>
									<xsl:element name="altova:TableCellColor">
									...
									<xsl:text>\clpadt45\clpadft3</xsl:text>
									<xsl:text>\clpadr45\clpadfr3</xsl:text>
									<xsl:value-of select="if ($altova:nColumnWidthTw_7_5 = $altova:nDefaultColumnWidthTw_7) then '\clftsWidth1' else ()"/>
									<xsl:text>\cellx</xsl:text>
									<xsl:variable name="altova:CurrGridPos_7" select="$altova:CurrGridPos_7 + $altova:nColumnWidthTw_7_5"/>
									<xsl:value-of select="ceiling($altova:CurrGridPos_7)"/>
									<xsl:text/>
									<xsl:text>\clvertalc</xsl:text>
									<xsl:element name="altova:TableCellColor">
									...
									<xsl:text>\clpadt45\clpadft3</xsl:text>
									<xsl:text>\clpadr45\clpadfr3</xsl:text>
									<xsl:value-of select="if ($altova:nColumnWidthTw_7_6 = $altova:nDefaultColumnWidthTw_7) then '\clftsWidth1' else ()"/>
									<xsl:text>\cellx</xsl:text>
									<xsl:variable name="altova:CurrGridPos_7" select="$altova:CurrGridPos_7 + $altova:nColumnWidthTw_7_6"/>
									<xsl:value-of select="ceiling($altova:CurrGridPos_7)"/>
									<xsl:text/>
									<xsl:text>\clvertalc</xsl:text>
									<xsl:element name="altova:TableCellColor">
									...
									<xsl:text>\clpadt45\clpadft3</xsl:text>
									<xsl:text>\clpadr45\clpadfr3</xsl:text>
									<xsl:value-of select="if ($altova:nColumnWidthTw_7_7 = $altova:nDefaultColumnWidthTw_7) then '\clftsWidth1' else ()"/>
									<xsl:text>\cellx</xsl:text>
									<xsl:variable name="altova:CurrGridPos_7" select="$altova:CurrGridPos_7 + $altova:nColumnWidthTw_7_7"/>
									<xsl:value-of select="ceiling($altova:CurrGridPos_7)"/>
									<xsl:text/>
									<xsl:text>\clvertalc</xsl:text>
									<xsl:element name="altova:TableCellColor">
									...
									<xsl:text>\clpadt45\clpadft3</xsl:text>
									<xsl:text>\clpadr45\clpadfr3</xsl:text>
									<xsl:value-of select="if ($altova:nColumnWidthTw_7_8 = $altova:nDefaultColumnWidthTw_7) then '\clftsWidth1' else ()"/>
									<xsl:text>\cellx</xsl:text>
									<xsl:variable name="altova:CurrGridPos_7" select="$altova:CurrGridPos_7 + $altova:nColumnWidthTw_7_8"/>
									<xsl:value-of select="ceiling($altova:CurrGridPos_7)"/>
									<xsl:text/>
									<xsl:text>\clvertalc</xsl:text>
									<xsl:element name="altova:TableCellColor">
									...
									<xsl:text>\clpadt45\clpadft3</xsl:text>
									<xsl:text>\clpadr45\clpadfr3</xsl:text>
									<xsl:value-of select="if ($altova:nColumnWidthTw_7_9 = $altova:nDefaultColumnWidthTw_7) then '\clftsWidth1' else ()"/>
									<xsl:text>\cellx</xsl:text>
									<xsl:variable name="altova:CurrGridPos_7" select="$altova:CurrGridPos_7 + $altova:nColumnWidthTw_7_9"/>
									<xsl:value-of select="ceiling($altova:CurrGridPos_7)"/>
									<xsl:text/>
									<xsl:text>\clvertalc</xsl:text>
									<xsl:element name="altova:TableCellColor">
									...
									<xsl:text>\clpadt45\clpadft3</xsl:text>
									<xsl:text>\clpadr45\clpadfr3</xsl:text>
									<xsl:value-of select="if ($altova:nColumnWidthTw_7_10 = $altova:nDefaultColumnWidthTw_7) then '\clftsWidth1' else ()"/>
									<xsl:text>\cellx</xsl:text>
									<xsl:variable name="altova:CurrGridPos_7" select="$altova:CurrGridPos_7 + $altova:nColumnWidthTw_7_10"/>
									<xsl:value-of select="ceiling($altova:CurrGridPos_7)"/>
								</xsl:variable>
								<xsl:if test="$templatetablelevel + 1 = 1">
					...
					<xsl:if test="count( n1:AttributesCommentsCollection )">
						...
						<xsl:variable name="altova:CurrContextGrid_0A7C2980" select="."/>
						<xsl:variable name="altova:ColumnData">
							<altova:Internal/>
						</xsl:variable>
						<altova:table>
					...
					<xsl:if test="count( n1:ConstraintsCollection )">
						...
						<xsl:variable name="altova:CurrContextGrid_071C3B00" select="."/>
						<xsl:variable name="altova:ColumnData">
							<altova:Internal/>
						</xsl:variable>
						<altova:table>
									...
									<altova:table-row>
										...
										<altova:table-cell altova:character-styles="\fs16" altova:character-reset-styles="\fs24" altova:paragraph-styles="\sl0">
											<xsl:if test="count( n1:RangesCollection ) != 0">
												<xsl:variable name="altova:CurrContextGrid_0A89A7F0" select="."/>
												<xsl:variable name="altova:ColumnData">
													<altova:Internal/>
												</xsl:variable>
												<altova:table>
											...
											<xsl:if test="count( n1:ValueListsCollection ) != 0">
												<xsl:variable name="altova:CurrContextGrid_08127940" select="."/>
												<xsl:variable name="altova:ColumnData">
													<altova:Internal/>
												</xsl:variable>
												<altova:table>
											...
											<xsl:if test="count( n1:CheckConstraintsCollection ) != 0">
												<xsl:variable name="altova:CurrContextGrid_08414D08" select="."/>
												<xsl:variable name="altova:ColumnData">
													<altova:Internal/>
												</xsl:variable>
												<altova:table>
					...
					<xsl:if test="count( n1:IdentifiersCollection )">
						...
						<xsl:variable name="altova:CurrContextGrid_0ABF2850" select="."/>
						<xsl:variable name="altova:ColumnData">
							<altova:Internal/>
						</xsl:variable>
						<altova:table>
					...
					<xsl:if test="count( n1:RelationshipsCollection )">
						...
						<xsl:variable name="altova:CurrContextGrid_07E4BA28" select="."/>
						<xsl:variable name="altova:ColumnData">
							<altova:Internal/>
						</xsl:variable>
						<altova:table>
							...
							<altova:table-row>
								<xsl:variable name="altova:RowStyle">
									...
									<xsl:text>\clpadt45\clpadft3</xsl:text>
									<xsl:text>\clpadr45\clpadfr3</xsl:text>
									<xsl:value-of select="if ($altova:nColumnWidthTw_14_6 = $altova:nDefaultColumnWidthTw_14) then '\clftsWidth1' else ()"/>
									<xsl:text>\cellx</xsl:text>
									<xsl:variable name="altova:CurrGridPos_14" select="$altova:CurrGridPos_14 + $altova:nColumnWidthTw_14_6"/>
									<xsl:value-of select="ceiling($altova:CurrGridPos_14)"/>
									<xsl:text/>
									<xsl:text>\clvertalc</xsl:text>
									<xsl:element name="altova:TableCellColor">
									...
									<xsl:text>\clpadt45\clpadft3</xsl:text>
									<xsl:text>\clpadr45\clpadfr3</xsl:text>
									<xsl:value-of select="if ($altova:nColumnWidthTw_14_7 = $altova:nDefaultColumnWidthTw_14) then '\clftsWidth1' else ()"/>
									<xsl:text>\cellx</xsl:text>
									<xsl:variable name="altova:CurrGridPos_14" select="$altova:CurrGridPos_14 + $altova:nColumnWidthTw_14_7"/>
									<xsl:value-of select="ceiling($altova:CurrGridPos_14)"/>
								</xsl:variable>
								<xsl:if test="$templatetablelevel + 1 = 1">
					...
					<xsl:if test="count( n1:IncomingProcessesCollection )">
						...
						<xsl:variable name="altova:CurrContextGrid_0A95B580" select="."/>
						<xsl:variable name="altova:ColumnData">
							<altova:Internal/>
						</xsl:variable>
						<altova:table>
					...
					<xsl:if test="count( n1:OutgoingProcessesCollection ) !=0">
						...
						<xsl:variable name="altova:CurrContextGrid_08424030" select="."/>
						<xsl:variable name="altova:ColumnData">
							<altova:Internal/>
						</xsl:variable>
						<altova:table>
	...
	<xsl:template name="altova:Section_0832A960_FooterRight">
		<xsl:variable name="altova:nMaxWidthIn" select="10.13"/>
		<xsl:variable name="templatetablelevel" select="0"/>
		<xsl:variable name="altova:CurrContextGrid_083321D0" select="."/>
		<xsl:variable name="altova:ColumnData">
			<altova:Internal/>
		</xsl:variable>
		<altova:table>
	...
	<xsl:template name="altova:Section_0832A960_FooterLeft">
		<xsl:variable name="altova:nMaxWidthIn" select="10.13"/>
		<xsl:variable name="templatetablelevel" select="0"/>
		<xsl:variable name="altova:CurrContextGrid_083321D0" select="."/>
		<xsl:variable name="altova:ColumnData">

							...
							<thead style="background-color:#d9f5ff; text-align:center; ">
								<tr>
									...
									<xsl:for-each select="*[n1:Column16/n1:show = &apos;Y&apos;]">
										<th style="border-bottom-color:black; border-bottom-style:solid; border-bottom-width:thin; border-left-color:black; border-left-style:solid; border-left-width:thin; border-right-color:black; border-right-style:solid; border-right-width:thin; border-top-color:black; border-top-style:solid; border-top-width:thin; width:{$XML/n1:root/n1:ObjectsCollection/n1:Column16}; ">
...
$v_Property1_Value
											...
											<xsl:for-each select="$altova:CurrContextGrid_1">
												<xsl:for-each select="*[n1:Column16/n1:show = &apos;Y&apos;]">
													<td style="border-bottom-color:black; border-bottom-style:solid; border-bottom-width:thin; border-left-color:black; border-left-style:solid; border-left-width:thin; border-right-color:black; border-right-style:solid; border-right-width:thin; border-top-color:black; border-top-style:solid; border-top-width:thin; width:{$XML/n1:root/n1:ObjectsCollection/n1:Column16}; ">
														<xsl:choose>
															<xsl:when test="$SV_OutputFormat = &apos;Authentic&apos;">

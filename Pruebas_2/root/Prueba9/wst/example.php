<?php
	...
	require_once('../lib/conexion.php'); // <-- this include file MUST go first before any HTML/output

	#the code for the class
	include ('../lib/CRUD.class.php'); // <-- this include file MUST go first before any HTML/output

    #this one line of code is how you implement the class
    ########################################################
    ##

    $tblDemo = new ajaxCRUD("Item", "usuario", "pkID", "../");
    ...
    $tblDemo->defineRelationship("servicio", "canal", "id_canal","descripcion"); //use your own table - this table (tblDemoRelationship) not included in the installation script
	#$tblDemo->defineRelationship("descripcion", "canal", "pkID", "servicio", "usuario"); //use your own table - this table (tblDemoRelationship) not included in the installation script
	...
	#Este sirve para mostrar los filtros
